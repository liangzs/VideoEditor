...
public abstract class SimpleSectionedAdapter<VH extends RecyclerView.ViewHolder> extends SectionedRecyclerViewAdapter<HeaderViewHolder,
    ...
    protected void onBindSectionHeaderViewHolder(HeaderViewHolder holder, int section) {
        ...
        holder.render(title);
        holder.showSelect(showSelect());
        holder.selectAll.setOnClickListener(v -> {
//            holder.selectAll.setSelected(!holder.selectAll.isSelected());
            selectAll(title, !holder.selectAll.isSelected());
        });
    }
