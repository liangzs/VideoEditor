...
import com.qiusuo.videoeditor.common.bean.MediaExtraInfo;
import com.qiusuo.videoeditor.module.select.config.Crop;
import com.qiusuo.videoeditor.module.select.config.CustomIntentKey;
...
import com.qiusuo.videoeditor.module.select.config.SelectLimitType;
...
import com.qiusuo.videoeditor.module.select.interfaces.OnItemClickListener;
import com.qiusuo.videoeditor.module.select.interfaces.OnKeyValueResultCallbackListener;
...
import com.qiusuo.videoeditor.module.select.repository.IBridgeMediaLoader;
...
import com.qiusuo.videoeditor.util.MediaStoreUtils;
import com.qiusuo.videoeditor.util.MediaUtils;
import com.qiusuo.videoeditor.util.PictureFileUtils;
import com.qiusuo.videoeditor.util.SdkVersionUtils;
import com.qiusuo.videoeditor.util.SpUtils;
...
//            if (PictureSelectionConfig.onResultCallListener == null) {
//                PictureSelectorEngine baseEngine = MyApplication.getInstance().getPictureSelectorEngine();
//
//                if (baseEngine != null) {
