...
JNIEXPORT jint JNICALL Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_play
...
//设置播放速率
JNIEXPORT jint JNICALL Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_setPlayRate
        (JNIEnv *env, jobject instance, jfloat playRate) {
    play_rate = playRate;
}

//获取视频总时长
JNIEXPORT jint JNICALL Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_getDuration
