...
#define FFMPEG_CONFIGURATION "--arch=arm --enable-small --enable-cross-compile --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-filters --enable-filter=aresample --enable-filter=asetpts --enable-filter=setpts --enable-filter=ass --enable-filter=scale --enable-filter=concat --enable-filter=atempo --enable-filter=movie --enable-filter=overlay --enable-filter=rotate --enable-filter=transpose --enable-filter=hflip --disable-encoders --enable-encoder=libx264 --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=rawvideo --enable-encoder=h263 --enable-encoder=png --enable-encoder=gif --enable-encoder=bmp --disable-decoders --enable-decoder=rawvideo --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=aac --enable-decoder=mp3 --enable-decoder=aac_latm --enable-decoder=h263 --enable-decoder=gif --enable-decoder=png --enable-decoder=bmp --enable-decoder=yuv4 --disable-muxers --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=mp3 --enable-muxer=h264 --enable-muxer=mpjpeg --enable-muxer=rawvideo --enable-muxer=wav --enable-muxer=mpegts --enable-muxer=dts --enable-muxer=gif --enable-muxer=flv --disable-demuxers --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=rawvideo --enable-demuxer=avi --enable-demuxer=wav --enable-demuxer=image2 --enable-demuxer=h263 --enable-demuxer=flv --enable-demuxer=gif --enable-demuxer=ogg --enable-demuxer=dts --enable-demuxer=m4v --enable-demuxer=concat --enable-demuxer=mpegts --enable-demuxer=mjpeg --enable-demuxer=mpegvideo --enable-demuxer=yuv4mpegpipe --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-parser=mpeg4video --enable-parser=mjpeg --enable-parser=ac3 --enable-parser=png --enable-parser=bmp --enable-parser=mpegvideo --enable-parser=mpegaudio --enable-zlib --disable-shared --enable-static --enable-version3 --enable-pthreads --disable-network --disable-vda --disable-iconv --disable-outdevs --enable-asm --enable-neon --enable-runtime-cpudetect --enable-gpl --enable-libx264 --extra-cflags=-I/mnt/e/ffmpeg/x264/build/include --extra-ldflags=-L/mnt/e/ffmpeg/x264/build/lib --disable-doc --enable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-postproc --enable-avdevice --disable-stripping --disable-doc --disable-symver --prefix=/mnt/e/ffmpeg/ffmpeg-3.3.9/android/armv7-a --cross-prefix=/mnt/d/IdeSDK/ndk/android-ndk-r14b-linux/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --target-os=android --cpu=armv7-a --sysroot=/mnt/d/IdeSDK/ndk/android-ndk-r14b-linux/platforms/android-14/arch-arm/"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/mnt/e/ffmpeg/ffmpeg-3.3.9/android/armv7-a/share/ffmpeg"
#define AVCONV_DATADIR "/mnt/e/ffmpeg/ffmpeg-3.3.9/android/armv7-a/share/ffmpeg"
...
#define CONFIG_GLTRANSITION_FILTER 0
