...
int init_audio(JNIEnv *env, jclass jthiz) {
    ...
    //获取音频解码器
    audioCodecCtx = pFormatCtx->streams[audio_stream_index]->codecpar;
...
JNIEXPORT jint JNICALL Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_filter
        (JNIEnv *env, jobject instance, jstring filePath, jobject surface, jstring filterDescr) {
    ...
    if (!is_playing) {
        ...
        //初始化音频解码器
//        if ((ret = init_audio(env, instance)) < 0){
...
Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_again(JNIEnv *env, jobject instance) {
    again = 1;
}

JNIEXPORT void JNICALL
Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_release(JNIEnv *env, jobject instance) {
    release = 1;
}

JNIEXPORT void JNICALL
Java_com_ijoysoft_mediasdk_module_ffmpeg_VideoPlayer_playAudio(JNIEnv *env, jobject instance,
                                                               jboolean play_audio) {
