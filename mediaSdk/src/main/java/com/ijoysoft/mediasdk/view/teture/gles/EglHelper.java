...
public class EglHelper implements IEglHelper {
    ...
    public EglContextWrapper start(EglContextWrapper eglContext) {
        LogUtils.w("EglHelper", "start() tid=" + Thread.currentThread().getId());
        /*
         * Get an EGL instance
         */
        ...
        LogUtils.w("EglHelper", "createContext " + mEglContext + " tid=" + Thread.currentThread().getId());
    ...
    public boolean createSurface(Object surface) {
        LogUtils.w("EglHelper", "createSurface()  tid=" + Thread.currentThread().getId());
        /*
         * Check preconditions.
         */
        if (mEgl == null) {
    ...
    public static void throwEglException(String function, int error) {
        ...
        LogUtils.e(TAG, "throwEglException tid=" + Thread.currentThread().getId() + " "
                + message);
