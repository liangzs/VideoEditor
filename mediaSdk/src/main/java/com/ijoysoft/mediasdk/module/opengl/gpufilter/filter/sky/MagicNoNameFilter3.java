 ...
 * 初夏
 */
public class MagicNoNameFilter3 extends GPUImageFilter {
    private int[] inputTextureHandles = {-1};
    private int[] inputTextureUniformLocations = {-1};
    private Context mContext;

    public MagicNoNameFilter3(MagicFilterType magicFilterType) {
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = OpenGlUtils.loadTexture("filter/green.png");
            }
        });
    }
