 ...
 * @ description
 */
public class TravelTenThemeTwo extends BaseBlurThemeExample {
    private BaseThemeExample widgetBorder;
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;

    public TravelTenThemeTwo(int totalTime, boolean isNoZaxis, int width, int height) {
...
//        outAnimation = new AnimationBuilder(DEFAULT_ENTER_TIME).setScale(1.1f, 1.1f).build();
        ...
        float centerY = width == height ? -0.6f : (width < height ? -0.4f : -0.5f);
