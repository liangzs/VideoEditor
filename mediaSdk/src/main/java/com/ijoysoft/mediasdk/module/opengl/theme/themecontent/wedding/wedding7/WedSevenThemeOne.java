 ...
 * @ description
 */
public class WedSevenThemeOne extends BaseBlurThemeExample {
    ...
    public WedSevenThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerY = width == height ? 0.85f : (width < height ? -0.9f : 0.88f);
