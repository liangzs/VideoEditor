 ...
 * 飘雪
 */
public class VTFiveDrawer implements IParticleRender {
    ...
    private VTFiveSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTFiveSystem(20);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_five_particle4" + ConstantMediaSize.SUFFIX));
