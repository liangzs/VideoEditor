 ...
 * stay 放大-缩小
 */
public class CDEightThemeFive extends BaseBlurThemeExample {

    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public CDEightThemeFive(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //文字
        float centerx = width < height ? 0.76f : (width == height ? 0.76f : 0.82f);
