...
//        index = 0;
        switch (index % 5) {
            case 0:
                actionRender = new CDFiveThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new CDFiveThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new CDFiveThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new CDFiveThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new CDFiveThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_five_theme_bg916" + ConstantMediaSize.SUFFIX));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_five_theme_bg11" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_five_theme_bg169" + ConstantMediaSize.SUFFIX));
                break;
        }
    }
...
//        index = 0;
        switch (index % 5) {
            case 0:
                temp = new CDFiveThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new CDFiveThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new CDFiveThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new CDFiveThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new CDFiveThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
