 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class Beat6ThemeManager extends BaseThemeManager {
    ...
    public void drawPrepare(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                actionRender = new Beat6ThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new Beat6ThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new Beat6ThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                actionRender = new Beat6ThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new Beat6ThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        bgImageFilter.draw();
    ...
    public IAction getNextAction(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                temp = new Beat6ThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new Beat6ThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new Beat6ThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                temp = new Beat6ThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new Beat6ThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
