 ...
 * 最后在fragment中，重写计划
 */
public class BabyTwoDrawer implements IParticleRender {
    ...
    private BabyTwoSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BabyTwoSystem(6);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_two_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_two_particle1" + ConstantMediaSize.SUFFIX));
