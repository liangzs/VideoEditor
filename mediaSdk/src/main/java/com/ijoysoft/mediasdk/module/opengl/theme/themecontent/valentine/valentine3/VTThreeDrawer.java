 ...
 * 最后在fragment中，重写计划
 */
public class VTThreeDrawer implements IParticleRender {
    ...
    private final String fragment = "precision mediump float; \n" +
            ...
            "        gl_FragColor=texture2D(u_Texture6, vec2( nx+0.5,ny+0.5));\n" +
            "    }\n" +
            "}\n";
    ...
    private VTThreeSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTThreeSystem(10);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle3" + ConstantMediaSize.SUFFIX));
        textures[3] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle4" + ConstantMediaSize.SUFFIX));
        textures[4] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle5" + ConstantMediaSize.SUFFIX));
        textures[5] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_three_particle6" + ConstantMediaSize.SUFFIX));
