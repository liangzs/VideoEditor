 ...
 */
public class WaveTransitionFilter extends TransitionFilter {
    private int mPrograssLocation;

    public WaveTransitionFilter(TransitionType transitionType) {
        super(transitionType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.transition_wave));
    }
