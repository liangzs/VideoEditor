...
import com.ijoysoft.mediasdk.module.opengl.theme.themecontent.celebration.celebration6.CDSixThemeFive;
 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class WeddingNineThemeManager extends BaseThemeManager {
    /**
     * 创建缓存对象，离屏buffer
     */
    ...
    public WeddingNineThemeManager() {
        super();
...
//        index = 3;
        switch (index % 4) {
            case 0:
                actionRender = new WedNineThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new WedNineThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new WedNineThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new WedNineThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new CDSixThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_nine_theme_bg916" + ConstantMediaSize.SUFFIX));

                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_nine_theme_bg11" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_nine_theme_bg169" + ConstantMediaSize.SUFFIX));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_nine_theme_bg916" + ConstantMediaSize.SUFFIX));
...
//        index = 3;
        switch (index % 4) {
            case 0:
                temp = new WedNineThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new WedNineThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new WedNineThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new WedNineThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new CDSixThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
