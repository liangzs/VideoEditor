 ...
 * @ description
 */
public class TravelThirteenDrawer implements IParticleRender {
    ...
    private TravelThirteenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new TravelThirteenSystem(7);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_thirteen_theme_particle1" + ConstantMediaSize.SUFFIX));
