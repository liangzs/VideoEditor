 ...
 * 朋友3
 */
public class Friend3Action0 extends BaseBlurThemeTemplate {


    public Friend3Action0(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //红
                    {0.9f, -0.9f, 0.5f, 0.5f, 0.5f},
                    //蓝
                    {-0.8f, 0.9f, 0.5f, 0.5f, 0.5f},
                    //标题
