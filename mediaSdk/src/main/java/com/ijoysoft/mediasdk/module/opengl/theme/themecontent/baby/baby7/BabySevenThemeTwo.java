 ...
 * stay 放大-缩小-放大
 */
public class BabySevenThemeTwo extends BaseBlurThemeExample {
    ...
    public BabySevenThemeTwo(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerx = width <= height ? 0 : 0f;
        ...
        originOne = widgetOne.adjustScaling(width / devideX, height / devideY, mimaps.get(0).getWidth(), mimaps.get(0).getHeight(), centerx, centery, scaleW, scaleH);
