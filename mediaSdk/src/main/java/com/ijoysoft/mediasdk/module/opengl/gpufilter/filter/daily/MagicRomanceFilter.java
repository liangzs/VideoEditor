...
public class MagicRomanceFilter extends GPUImageFilter {
    ...
    public MagicRomanceFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.mediasdk_filter_romance));
    }
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = createRawTexture();
            }
        });
    }

    private int createRawTexture() {
        ...
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, 256, 2, 0, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, ByteBuffer.wrap(romance_arrayOfByte));
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
        return textureid[0];
    }
}
