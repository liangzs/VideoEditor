 ...
 * 缩小-放大-缩小
 */
public class HoliElevenThemeFour extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public HoliElevenThemeFour(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scale = width < height ? 1.2f : 1.2f;
