...
public class BDTenThemeOne extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetBorder;

    public BDTenThemeOne(int totalTime) {
    ...
    public void initWidget() {
        ...
        widgetOne.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(-2).setCoordinate(0, 1f, 0f, 0f)
                .build());
