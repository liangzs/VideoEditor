...
public class MagicSunsetFilter extends GPUImageFilter {
    ...
    public MagicSunsetFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_sunset));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture("filter/rise_mask1.webp");
                mMaskGrey2TextureId = OpenGlUtils.loadTexture("filter/rise_mask2.webp");
            }
        });
    }
...
//        return GpuFilterFactory.NAME_SUNSET;
//    }
}
