 ...
 * stay 放大-缩小
 */
public class HDFourteenThemeFive extends BaseBlurThemeExample {
    ...
    public HDFourteenThemeFive(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centerY = width < height ? -0.7f : (width == height ? -0.6f : -0.7f);
