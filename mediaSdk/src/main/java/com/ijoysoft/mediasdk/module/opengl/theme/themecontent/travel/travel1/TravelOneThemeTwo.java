 ...
 * 左y轴翻转进，左下角出z轴翻转出
 */
public class TravelOneThemeTwo extends BaseThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;
    private BaseThemeExample widgetFour;

    public TravelOneThemeTwo(int totalTime, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //two
        centerX = width < height ? -0.55f : (width == height ? -0.55f : -0.65f);
        centerY = width < height ? -0.7f : (width == height ? -0.65f : -0.6f);
        ...
        scaleX = width < height ? 2.5f : (width == height ? 2.5f : 3.5f);
        //four
        centerX = width < height ? 0.5f : (width == height ? 0.6f : 0.7f);
        centerY = width < height ? 0.8f : (width == height ? 0.8f : 0.7f);
