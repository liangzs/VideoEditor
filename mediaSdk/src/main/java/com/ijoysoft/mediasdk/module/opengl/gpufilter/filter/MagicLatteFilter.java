...
public class MagicLatteFilter extends GPUImageFilter {
    ...
    public MagicLatteFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.latte));
    }
