 ...
 * @ description
 */
public class LoveFourThemeThree extends BaseBlurThemeExample {
    ...
    public LoveFourThemeThree(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width == height ? 2.8f : (width < height ? 2.5f : 3.5f);
        float scaleY = width == height ? 2.8f : (width < height ? 2.5f : 3.5f);
        float centerX = width == height ? 0f : (width < height ? 0f : 0f);
        float centerY = width == height ? 0f : (width < height ? 0f : 0f);
