 ...
 * 最后在fragment中，重写计划
 */
public class TravelSevenDrawer implements IParticleRender {
    ...
    private TravelSevenSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public TravelSevenDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new TravelSevenSystem(3);
        globalStartTime = System.currentTimeMillis();

        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_seven_particle" + ConstantMediaSize.SUFFIX));
