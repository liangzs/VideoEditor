...
public class VTElevenSystem extends BaseParticleSystem {
    ...
    public VTElevenSystem(int maxParticleCount) {
    ...
    public void addParticle(float particleStartTime) {
        pointSize = Math.min(ConstantMediaSize.showViewWidth, ConstantMediaSize.showViewHeight) / 60;
