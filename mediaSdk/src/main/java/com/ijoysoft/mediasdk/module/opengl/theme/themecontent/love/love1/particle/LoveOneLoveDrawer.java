 ...
 * @ description
 */
public class LoveOneLoveDrawer implements IParticleRender {
    ...
    private LoveOneLoveSystem particleSystem;
    ...
    public LoveOneLoveDrawer() {
        particleProgram = new ParticleShaderProgram(vertex, fragment);
        particleSystem = new LoveOneLoveSystem(6);
