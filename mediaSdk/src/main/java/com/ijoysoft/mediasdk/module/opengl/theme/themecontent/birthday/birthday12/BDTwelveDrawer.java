 ...
 * 最后在fragment中，重写计划
 */
public class BDTwelveDrawer implements IParticleRender {
    ...
    private BDTwelveSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDTwelveSystem(10);
        globalStartTime = System.currentTimeMillis();

        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_twelve_particle3" + ConstantMediaSize.SUFFIX));
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_twelve_particle1" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_twelve_particle2" + ConstantMediaSize.SUFFIX));
