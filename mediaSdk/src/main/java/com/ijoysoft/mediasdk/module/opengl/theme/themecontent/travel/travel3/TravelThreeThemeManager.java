 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class TravelThreeThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new TravelThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new TravelThreeThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new TravelThreeThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new TravelThreeThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new TravelThreeThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new TravelThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new TravelThreeThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new TravelThreeThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new TravelThreeThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new TravelThreeThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
