 ...
 * @ description
 */
public class TravelThirteenSystem extends BaseParticleSystem {
    ...
    public TravelThirteenSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = ConstantMediaSize.getMinWH() / 40;//(20,25,30)
        if (isInit) {
        ...
        vertexArray.updateBuffer(particles, particleOffset, TOTAL_COUNT);
        particles[currentOffset++] = random.nextInt(1) * 1f;
    }
