package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.valentine.valentine5.particle;
...
public class VTFiveSystemTwo extends BaseParticleSystem {
    ...
    public VTFiveSystemTwo(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        particles[currentOffset++] = random.nextInt(3);
        vertexArray.updateBuffer(particles, particleOffset, TOTAL_COUNT);
    }
