...
public class MediaVideoEncoderRunable extends BaseMediaEncoderRunable {
     ...
     * @param height
     */
    public MediaVideoEncoderRunable(final RealTimeMediaMuxerManager mediaMuxerManager, final MediaEncoderListener mediaEncoderListener, final int width, final int height) {
