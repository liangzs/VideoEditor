 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class CDSevenThemeManager extends BaseThemeManager {
    /**
     * 创建缓存对象，离屏buffer
     */
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new CDSevenThemeOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                actionRender = new CDSevenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new CDSevenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new CDSevenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new CDSevenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_seven_theme_bg916" + ConstantMediaSize.SUFFIX));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_seven_theme_bg11" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_seven_theme_bg169" + ConstantMediaSize.SUFFIX));
                break;
        }
    }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new CDSevenThemeOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                temp = new CDSevenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new CDSevenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new CDSevenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new CDSevenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
