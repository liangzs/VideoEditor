 ...
 * 右边波浪进
 */
public class VTTweleThemeTwo extends BaseThemeExample {
    ...
    public VTTweleThemeTwo(int totalTime) {
        ...
        enterAnimation = new WaveAnimation(new AnimationBuilder(DEFAULT_OUT_TIME).
                setCoordinate(2.5f, 0f, 0, 0).setZView(-2.5f).setScale(1.1f, 1.1f));
        outAnimation = new WaveAnimation(new AnimationBuilder(DEFAULT_OUT_TIME).
                setCoordinate(0f, 0f, -2.5f, 0).setZView(-2.5f).setScale(1.1f, 1.1f));
        setZView(-2.5f);
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 4f : 8f;
        scaleY = width < height ? 8f : 4f;
