 ...
 * stay 放大-缩小
 */
public class TravelThreeThemeFive extends BaseBlurThemeExample {
    private BaseThemeExample widgetBorder;
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public TravelThreeThemeFive(int totalTime, boolean isNoZaxis, int width, int height) {
        ...
        widgetTwo.setEnterAnimation(new AnimationBuilder(3000).setZView(0).setIsNoZaxis(true).
                setCoordinate(-1.5f, 0.5f, 0, 0).build());
