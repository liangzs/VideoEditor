 ...
 * 生日21
 */
public class Birthday21Action2 extends BaseBlurThemeTemplate {




    public Birthday21Action2(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //三种颜色效果
                    {-1f, -0.3f, 0.7f, 1.4f, 1.4f},
                    {1f, 0.5f, 0.7f, 1.4f, 1.4f},
                    {0.4f, -1f, 0.7f, 1.4f, 1.4f},
                    //气球
