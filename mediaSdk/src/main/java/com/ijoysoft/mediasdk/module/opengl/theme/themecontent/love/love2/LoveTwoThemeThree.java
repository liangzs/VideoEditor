 ...
 * @ description
 */
public class LoveTwoThemeThree extends BaseThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public LoveTwoThemeThree(int totalTime) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width == height ? 4f : (width < height ? 0f : 4f);
        scaleY = width == height ? 4f : (width < height ? 0f : 4f);
