 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BabyThreeThemeManager extends BaseThemeManager {
...
//        index = 3;
        switch (index % 5) {
            case 0:
                actionRender = new BabyThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new BabyThreeThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new BabyThreeThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new BabyThreeThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new BabyThreeThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 3;
        ...
        switch (index % 5) {
            case 0:
                temp = new BabyThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new BabyThreeThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new BabyThreeThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new BabyThreeThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new BabyThreeThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
