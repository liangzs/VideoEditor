 ...
 */
public class VTFifteenSystem extends BaseParticleSystem {
    ...
    private static final float pointSize = 3;
     ...
     * @param duration
     */
    public VTFifteenSystem(int duration) {
    ...
    public void addParticles() {
        ...
        for (int i = 0; i < flowerNum; i++) {
            ...
            particles[currentOffset++] = (1 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 30;//大小
