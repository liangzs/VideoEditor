...
public class MagicCoolFilter extends GPUImageFilter {
    ...
    public MagicCoolFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.mediasdk_filter_cool));
    }
