...
public class WidgetThreeFlowerSystem extends BaseParticleSystem {
    ...
    private static final int flowerNum = 6;
    private float current;
    private float origin;

    public WidgetThreeFlowerSystem() {
    ...
    public void addParticles() {
        ...
        for (int i = 0; i < flowerNum; i++) {
            ...
            switch (i) {
                case 0:
                    position = new Geometry.Point(-0.85f, -0.8f, 0f);
                    particles[currentOffset + 1] = ConstantMediaSize.getMinWH() / 2;
                    break;
                case 1:
                    position = new Geometry.Point(-0.75f, -0.9f, 0f);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                case 4:
                    position = new Geometry.Point(0.75f, 0.8f, 0f);
                    break;
                case 5:
                    position = new Geometry.Point(0.9f, 0.85f, 0f);
                    break;
                default:
