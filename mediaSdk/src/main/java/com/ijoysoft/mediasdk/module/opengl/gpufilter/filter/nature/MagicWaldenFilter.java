...
public class MagicWaldenFilter extends GPUImageFilter {
    ...
    public MagicWaldenFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_walden));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                inputTextureHandles[1] = OpenGlUtils.loadTexture("filter/vignette_map.webp");
            }
        });
    }
}
