 ...
 * 最后在fragment中，重写计划
 */
public class HDOneDrawer implements IParticleRender {
    ...
    private HDOneSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDOneSystem(10);
    ...
    public Bitmap loadBitmap() {
        return BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_one_particle" + ConstantMediaSize.SUFFIX);
    }
