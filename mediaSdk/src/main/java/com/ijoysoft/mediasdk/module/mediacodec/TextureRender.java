...
import com.ijoysoft.mediasdk.module.opengl.filter.RotationOESFilter;
...
class TextureRender {
    ...
    public TextureRender(VideoInfo info) {
        ...
        rotationFilter = new RotationOESFilter();
    }
...
//        st.getTransformMatrix(mSTMatrix);//当视频角度不为0时,这里会导致视频方向不对
    ...
    public void surfaceCreated() {
        ...
        if(!isClipMode){
            ...
            switch (curMode){
//                case ConstantMediaSize.MODE_POR_9_16:
//                    clipViewWidth= ConstantMediaSize.mode_por_width_9_16;
//                    clipViewHeight= ConstantMediaSize.mode_por_height_9_16;
//                    clipEncodeWidth= ConstantMediaSize.mode_por_encode_width_9_16;
//                    clipEncodeHeight= ConstantMediaSize.mode_por_encode_height_9_16;
//                    break;
//                case ConstantMediaSize.MODE_POR_1_1:
//                    clipViewWidth= ConstantMediaSize.mode_por_width_1_1;
//                    clipViewHeight= ConstantMediaSize.mode_por_height_1_1;
//                    clipEncodeWidth= ConstantMediaSize.mode_por_encode_width_1_1;
//                    clipEncodeHeight= ConstantMediaSize.mode_por_encode_height_1_1;
//                    break;
//                case ConstantMediaSize.MODE_POR_16_9:
//                    clipViewWidth= ConstantMediaSize.mode_por_width_16_9;
//                    clipViewHeight= ConstantMediaSize.mode_por_height_16_9;
//                    clipEncodeWidth= ConstantMediaSize.mode_por_encode_width_16_9;
//                    clipEncodeHeight= ConstantMediaSize.mode_por_encode_height_16_9;
//                    break;
            }
