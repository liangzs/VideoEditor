 ...
 */
public class TurnPageFilter extends TransitionFilter {

    private int mPrograssLocation;

    public TurnPageFilter(TransitionType transitionType) {
        super(transitionType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.transition_turn_the_page));
    }
