...
public class MagicPixarFilter extends GPUImageFilter {
    ...
    public MagicPixarFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_pixar));
    }
