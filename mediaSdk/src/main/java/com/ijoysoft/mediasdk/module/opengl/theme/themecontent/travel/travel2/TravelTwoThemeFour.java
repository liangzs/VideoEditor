 ...
 * 左上角z轴翻滚进，右下角z轴滚出
 */
public class TravelTwoThemeFour extends BaseThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;

    public TravelTwoThemeFour(int totalTime, int width, int height) {
    ...
    public void initWidget() {
        ...
        widgetThree.setEnterAnimation(new EnterEaseOutElastic(new AnimationBuilder(DEFAULT_ENTER_TIME).setIsNoZaxis(true).setZView(0).
                setCoordinate(0, 1, 0f, 0f).setOrientation(AnimateInfo.ORIENTATION.BOTTOM)));
    }
