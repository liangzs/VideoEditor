package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.greeting.greeting5.particletwo;
 ...
 * 最后在fragment中，重写计划
 */
public class GreetFiveParticleDrawerTwo implements IParticleRender {
    private float[] viewProjectionMatrix = MatrixUtils.getOriginalMatrix();
    private ParticleShaderProgram particleProgram;
    private GreetFiveParticleSystemTwo particleSystem;
    private int[] textures = new int[8];
    private int[] textureLocations = new int[8];
    private long globalStartTime;

    public GreetFiveParticleDrawerTwo() {
        particleSystem = new GreetFiveParticleSystemTwo();
