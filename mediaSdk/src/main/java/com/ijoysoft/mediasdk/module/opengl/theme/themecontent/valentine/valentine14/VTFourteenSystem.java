...
public class VTFourteenSystem extends BaseParticleSystem {
    ...
    public VTFourteenSystem(int maxParticleCount) {
    ...
    private void updateParticle(int index) {
        ...
        if (current < 0.3) {//准备消失
            pointSize = particles[currentOffset + 2];
            pointSize = pointSize < 0 ? 0 : pointSize;
            particles[currentOffset + 2] = pointSize;
        }
