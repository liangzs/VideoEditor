 ...
 * 兄妹节2
 */
public class RBTwoActionFive extends BaseBlurThemeTemplate {


    public RBTwoActionFive(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetMeta == null) {
            widgetMeta = new float[][]{
                    ...
                    {0.2f, 0.65f, 2f, 2f},
                    {1.2f, -0.2f, 1.7f, 1.7f},
                    {0.65f, 0.82f, 1.7f, 1.7f},
                    {-0.85f, -0.9f, 1.7f, 1.7f},
    ...
    final float[][][] rotateWidgetsMeta = new float[][][]{{{0.2f, 0.6f, 0f, 0.3f}}};
