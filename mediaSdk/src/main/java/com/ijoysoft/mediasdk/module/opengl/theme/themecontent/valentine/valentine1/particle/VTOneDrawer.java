 ...
 * 最后在fragment中，重写计划
 */
public class VTOneDrawer implements IParticleRender {
    ...
    private VTOneSystem particleSystem;
...
//        onDestroy();
        ...
        particleSystem = new VTOneSystem(30);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_one_particle1"));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_one_particle2"));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_one_particle3"));
        textures[3] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_one_particle4"));
