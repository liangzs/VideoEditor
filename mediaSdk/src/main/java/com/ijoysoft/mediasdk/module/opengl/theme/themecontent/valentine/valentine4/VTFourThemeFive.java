 ...
 * 上进，上下悬停，左划出
 */
public class VTFourThemeFive extends BaseThemeExample {

    public VTFourThemeFive(int totalTime) {
        ...
        enterAnimation = new AnimationBuilder(DEFAULT_ENTER_TIME).setCoordinate(0f, -2.0f, 0, 0).
                setConors(AnimateInfo.ROTATION.Y_ANXIS_RE, 0, 0).setZView(VTFourThemeManager.CUSTOM_ZVIEW).build();
        outAnimation = new AnimationBuilder(DEFAULT_ENTER_TIME).setCoordinate(0f, 0f, 0, 2.5f).setZView(VTFourThemeManager.CUSTOM_ZVIEW).build();
    }
