...
public class BDEightteenSystem extends BaseParticleSystem {
    ...
    public BDEightteenSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (1 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 50;//(20,25,30)
