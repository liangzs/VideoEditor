 ...
 * @ description
 */
public class LoveSevenDrawer implements IParticleRender {
    ...
    private LoveSevenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new LoveSevenSystem(7);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/love_seven_theme_particle1" + ConstantMediaSize.SUFFIX));
