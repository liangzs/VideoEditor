 ...
 * 最后在fragment中，重写计划
 */
public class BabyThreeDrawer implements IParticleRender {
    ...
    private BabyThreeSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public BabyThreeDrawer() {
        particleSystem = new BabyThreeSystem(7);
