 ...
 * @ description  花瓣粒子
 */
public class LoveThreePetalDrawer implements IParticleRender {
    ...
    private LoveThreePetalSystem particleSystem;
    ...
    public LoveThreePetalDrawer() {
        particleProgram = new ParticleShaderProgram(vertex, fragment);
        particleSystem = new LoveThreePetalSystem(10);
