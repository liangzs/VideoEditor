 ...
 * 最后在fragment中，重写计划
 */
public class CDNineDrawer implements IParticleRender {
    ...
    private CDNineSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new CDNineSystem(8);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_nine_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_nine_particle2" + ConstantMediaSize.SUFFIX));
