...
public abstract class BaseMediaEncoderRunable implements Runnable {
    ...
    protected RealTimeMediaMuxerManager mSohuMediaMuxerManager;
    //
     ...
     */
    public BaseMediaEncoderRunable(final RealTimeMediaMuxerManager mediaMuxerManager, final MediaEncoderListener mediaEncoderListener) {
