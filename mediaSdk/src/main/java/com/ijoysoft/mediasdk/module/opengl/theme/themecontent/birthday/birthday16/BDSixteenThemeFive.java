...
public class BDSixteenThemeFive extends BaseBlurThemeExample {
    ...
    public BDSixteenThemeFive(int totalTime) {
    ...
    public void initWidget() {
        ...
        widgetThree.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setOrientation(AnimateInfo.ORIENTATION.TOP).setIsNoZaxis(true).
                setCoordinate(0, -1.0f, 0f, 0f).setZView(-0.0f).build());
        widgetThree.setZView(-0.0f);


        widgetFour = new BaseThemeExample(totalTime, 2200, 2000, DEFAULT_OUT_TIME, true);
        widgetFour.setEnterAnimation(new EnterEaseOutElastic(new AnimationBuilder(DEFAULT_ENTER_TIME).setOrientation(AnimateInfo.ORIENTATION.TOP).setIsNoZaxis(true).
                setEnterDelay(500).setCoordinate(0, -1.0f, 0f, 0f).setZView(-0.0f)));
        widgetFour.setZView(-0.0f);
        widgetFive = new BaseThemeExample(totalTime, 2200, 2000, DEFAULT_OUT_TIME, true);
        widgetFive.setEnterAnimation(new EnterEaseOutElastic(new AnimationBuilder(DEFAULT_ENTER_TIME).setOrientation(AnimateInfo.ORIENTATION.TOP).setIsNoZaxis(true).
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 8 : (width == height ? 7 : 7);
        centerX = width < height ? -0.8f : (width == height ? -0.8f : -0.8f);
        centerY = width < height ? -0.88f : (width == height ? -0.85f : -0.85f);
        ...
        centerX = width < height ? 0.65f : (width == height ? 0.7f : 0.77f);
        centerY = width < height ? -0.7f : (width == height ? -0.7f : -0.65f);
        ...
        centerY = width < height ? -0.65f : (width == height ? -0.65f : -0.6f);
