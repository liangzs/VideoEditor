 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class LoveTwoThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new LoveTwoThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new LoveTwoThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new LoveTwoThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new LoveTwoThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new LoveTwoThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new LoveTwoThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new LoveTwoThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new LoveTwoThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new LoveTwoThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new LoveTwoThemeFive((int) mediaItem.getDuration());
                break;
        }
