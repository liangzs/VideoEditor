 ...
 * 最后在fragment中，重写计划
 */
public class BDOneDrawer implements IParticleRender {
    ...
    private BDOneSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDOneSystem(8);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_one_particle1"));
