 ...
 * 最后在fragment中，重写计划
 */
public class VTThirteenDrawer implements IParticleRender {
    ...
    private VTThirteenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTThirteenSystem(20);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_thirteen_particle1" + ConstantMediaSize.SUFFIX));
