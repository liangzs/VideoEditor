 ...
 * 飘雪
 */
public class HDTwelveDrawer implements IParticleRender {
    ...
    private HDTwelveSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDTwelveSystem(40);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_twelve_particle4" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_twelve_particle1" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_twelve_particle2" + ConstantMediaSize.SUFFIX));
