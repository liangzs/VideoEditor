 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class GreetingThreeThemeManager extends BaseThemeManager {
...
//        index = 3;
        switch (index % 4) {
            case 0:
                actionRender = new GreetThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new GreetThreeThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                actionRender = new GreetThreeThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                actionRender = new GreetThreeThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 3;
        ...
        switch (index % 4) {
            case 0:
                temp = new GreetThreeThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new GreetThreeThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                temp = new GreetThreeThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                temp = new GreetThreeThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
        }
