 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class CDFourThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new CDFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new CDFourThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new CDFourThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new CDFourThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new CDFourThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new CDFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new CDFourThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new CDFourThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new CDFourThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new CDFourThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
