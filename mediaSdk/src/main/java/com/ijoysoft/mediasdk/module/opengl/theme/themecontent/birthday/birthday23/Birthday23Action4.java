 ...
 * 生日23
 */
public class Birthday23Action4 extends BaseBlurThemeTemplate {



    public Birthday23Action4(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    ...
                    //气球
                    {Float.MAX_VALUE, Float.MAX_VALUE, 1f, 1f, 1f},
            };
        }
        return widgetsMeta;
    }
