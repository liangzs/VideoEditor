 ...
 * 缩小-放大-缩小
 */
public class Beat6ThemeFour extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public Beat6ThemeFour(int totalTime, boolean isNoZaxis) {
        ...
        widgetTwo.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setIsNoZaxis(true).
                setCoordinate(1, 0, 0, 0).
                setOrientation(AnimateInfo.ORIENTATION.RIGHT).build());
        widgetTwo.setOutAnimation(new AnimationBuilder(DEFAULT_OUT_TIME).setIsNoZaxis(true).
                setCoordinate(0, 0, -1.5f, 0).setFade(1, 0).
                setOrientation(AnimateInfo.ORIENTATION.LEFT).build());
