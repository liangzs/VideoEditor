 ...
 * 飘雪
 */
public class TravelEightDrawer implements IParticleRender {
    ...
    private TravelEightSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new TravelEightSystem(30);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_eight_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_eight_particle2" + ConstantMediaSize.SUFFIX));
