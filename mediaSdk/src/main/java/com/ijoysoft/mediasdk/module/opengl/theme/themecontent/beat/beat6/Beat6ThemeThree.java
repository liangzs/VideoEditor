 ...
 * stay 缩小
 */
public class Beat6ThemeThree extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;

    public Beat6ThemeThree(int totalTime, int width, int height, boolean isNoZaxis) {
        ...
        widgetOne.setEnterAnimation(new EnterEaseOutElastic(new AnimationBuilder(DEFAULT_ENTER_TIME).
                setCoordinate(0, 1, 0, 0).setIsNoZaxis(true).
                setOrientation(AnimateInfo.ORIENTATION.BOTTOM)));
