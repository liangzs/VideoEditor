 ...
 * stay 放大-缩小-放大
 */
public class WedEightThemeTwo extends BaseBlurThemeExample {
    ...
    public WedEightThemeTwo(int totalTime, boolean isNoZaxis, int width, int height) {
