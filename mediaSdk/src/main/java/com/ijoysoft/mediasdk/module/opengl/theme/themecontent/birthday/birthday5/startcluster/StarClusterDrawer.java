package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.birthday.birthday5.startcluster;
 ...
 */
public class StarClusterDrawer implements IParticleRender {
    ...
    public StarClusterDrawer(BaseParticleSystem particleSystem) {
        this.particleSystem = particleSystem;
        particleProgram = new ParticleShaderProgram(VERTEXT, FRAGMENT);
        globalStartTime = System.currentTimeMillis();
        particleSystem.addParticles();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_five_particle1" + ConstantMediaSize.SUFFIX));
