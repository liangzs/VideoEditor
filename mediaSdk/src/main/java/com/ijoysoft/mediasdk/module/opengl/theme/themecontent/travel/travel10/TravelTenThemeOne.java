 ...
 * @ description
 */
public class TravelTenThemeOne extends BaseBlurThemeExample {
    ...
    public TravelTenThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width == height ? 3 : (width < height ? 2 : 3);
        float scaleY = width == height ? 3 : (width < height ? 2 : 3);
        ...
        centerY = width == height ? -0.6f : (width < height ? -0.4f : -0.5f);
        ...
        origin = widgetThree.adjustScaling(width, height,
