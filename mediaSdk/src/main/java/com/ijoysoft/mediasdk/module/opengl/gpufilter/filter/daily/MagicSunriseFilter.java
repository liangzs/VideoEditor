...
public class MagicSunriseFilter extends GPUImageFilter {
    ...
    public MagicSunriseFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_sunrise));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
                mMaskGrey1TextureId = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/amaro_mask1.webp");
                GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
                mMaskGrey2TextureId = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/amaro_mask2.webp");
                GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
                mMaskGrey3TextureId = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/toy_mask1.webp");
            }
        });
    }
...
//        return GpuFilterFactory.NAME_SUNRISE;
//    }
}
