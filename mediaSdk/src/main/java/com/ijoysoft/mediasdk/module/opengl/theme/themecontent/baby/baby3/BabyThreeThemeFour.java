 ...
 * 缩小-放大-缩小
 */
public class BabyThreeThemeFour extends BaseBlurThemeExample {
    ...
    public BabyThreeThemeFour(int totalTime, boolean isNoZaxis) {
        ...
        mBabyThreeCloudDrawer = new BabyThreeCloudDrawer(new BabyThreeCloudSystem(BabyThreeCloudSystem.THREE));
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //顶点坐标
        float scale = width < height ? 1.5f : (width == height ? 2f : 3);

        widgetOne.adjustScaling(width, height, mimaps.get(1).getWidth(), mimaps.get(1).getHeight(), 0, 0.7f, scale, scale);
