 ...
 * 最后在fragment中，重写计划
 */
public class VTFiveDrawerTwo implements IParticleRender {
    ...
    private VTFiveSystemTwo particleSystem;
    ...
    public VTFiveDrawerTwo(){
        particleProgram = new ParticleShaderProgram(vertex, fragment);
        particleSystem = new VTFiveSystemTwo(6);
    }
