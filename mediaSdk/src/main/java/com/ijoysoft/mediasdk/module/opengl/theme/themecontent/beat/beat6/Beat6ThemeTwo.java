 ...
 * stay 放大-缩小-放大
 */
public class Beat6ThemeTwo extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;

    public Beat6ThemeTwo(int totalTime, boolean isNoZaxis) {
        ...
        widgetOne.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setIsNoZaxis(true).setCoordinate(1.5f, 0, 0, 0).
