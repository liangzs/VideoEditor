 ...
 * 兄妹节2
 */
public class RBOneActionTwo extends BaseBlurThemeTemplate {

    public RBOneActionTwo(int totalTime, int width, int height) {
...
//                setZView(0).build();
    ...
    //0.38 = 240/632    720p下 Min wh = 632
    float[][][] rotateWidgetMeta = new float[][][]{{{0.55f, 0.78f, 0f, 0.38f}}};
