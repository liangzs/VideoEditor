 ...
 * @ description
 */
public class HDTwoDrawer implements IParticleRender {
    ...
    private HDTwoSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDTwoSystem(40);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_two_particle2" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_two_particle1" + ConstantMediaSize.SUFFIX));
