 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDThirteenThemeManager extends BaseThemeManager {
...
//        index = 0;
        switch (index % 5) {
            case 0:
                actionRender = new BDThirteenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BDThirteenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new BDThirteenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new BDThirteenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new BDThirteenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirteen_theme_bg" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirdteen_bg169" + ConstantMediaSize.SUFFIX));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirdteen_bg11" + ConstantMediaSize.SUFFIX));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirteen_theme_bg" + ConstantMediaSize.SUFFIX));
                break;
...
//        index = 0;
        switch (index % 5) {
            case 0:
                temp = new BDThirteenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new BDThirteenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new BDThirteenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new BDThirteenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new BDThirteenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
