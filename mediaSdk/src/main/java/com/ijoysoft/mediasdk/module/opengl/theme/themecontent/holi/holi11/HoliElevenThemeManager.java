 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HoliElevenThemeManager extends BaseThemeManager {
    ...
    public void drawPrepare(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                actionRender = new HoliElevenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new HoliElevenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new HoliElevenThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                actionRender = new HoliElevenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new HoliElevenThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        bgImageFilter.draw();
    ...
    public IAction getNextAction(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                temp = new HoliElevenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new HoliElevenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new HoliElevenThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                temp = new HoliElevenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new HoliElevenThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
