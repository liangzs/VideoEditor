...
public class MagicSweetsFilter extends GPUImageFilter {
    ...
    public MagicSweetsFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_sweets));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture("filter/rise_mask2.webp");
            }
        });
    }
}
