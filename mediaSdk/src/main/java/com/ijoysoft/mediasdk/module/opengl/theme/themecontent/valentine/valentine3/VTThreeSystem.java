...
public class VTThreeSystem extends BaseParticleSystem {
    ...
    public VTThreeSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = (2 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 40;//(20,25,30)
        if (isInit) {
        ...
        particles[currentOffset++] = random.nextInt(6) * 1f;
        vertexArray.updateBuffer(particles, particleOffset, TOTAL_COUNT);
    }
