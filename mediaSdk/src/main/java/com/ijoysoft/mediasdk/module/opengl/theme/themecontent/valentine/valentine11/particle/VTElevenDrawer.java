package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.valentine.valentine11.particle;
 ...
 * 最后在fragment中，重写计划
 */
public class VTElevenDrawer implements IParticleRender {
    ...
    private VTElevenSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public VTElevenDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTElevenSystem(10);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_eleven_theme_particle" + ConstantMediaSize.SUFFIX));
