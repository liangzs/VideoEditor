 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HoliEightThemeManager extends BaseThemeManager {
    ...
    public void drawPrepare(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                actionRender = new HoliEightThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new HoliEightThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new HoliEightThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                actionRender = new HoliEightThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new HoliEightThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        bgImageFilter.draw();
    ...
    public IAction getNextAction(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                temp = new HoliEightThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new HoliEightThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new HoliEightThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                temp = new HoliEightThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new HoliEightThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
