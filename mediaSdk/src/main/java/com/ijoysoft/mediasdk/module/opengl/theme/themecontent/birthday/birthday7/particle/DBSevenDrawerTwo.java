 ...
 */
public class DBSevenDrawerTwo implements IParticleRender {
    ...
    private BDSevenSystemTwo particleSystem;
    private long globalStartTime;
    private int texture;

    public DBSevenDrawerTwo() {
        particleProgram = new ParticleShaderProgram(VERTEXT, FRAGMENT);
        globalStartTime = System.currentTimeMillis();
        particleSystem = new BDSevenSystemTwo();
    }
