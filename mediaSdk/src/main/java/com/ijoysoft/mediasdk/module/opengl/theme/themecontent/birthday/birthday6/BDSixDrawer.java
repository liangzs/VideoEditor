 ...
 * 最后在fragment中，重写计划
 */
public class BDSixDrawer implements IParticleRender {
    ...
    private BDSixSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDSixSystem(20);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_six_particle1" + ConstantMediaSize.SUFFIX));
