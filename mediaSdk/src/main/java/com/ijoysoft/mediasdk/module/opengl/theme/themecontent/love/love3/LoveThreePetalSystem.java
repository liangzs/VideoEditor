 ...
 * @ description
 */
public class LoveThreePetalSystem extends BaseParticleSystem {
    ...
    public LoveThreePetalSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (1 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 40;//(20,25,30)
