 ...
 * TODO 比例适配
 */
public class Rakshabandhan8ThemeManager extends BaseThemeManager {
    ...
    public Rakshabandhan8ThemeManager() {
        super();
...
//        index=0;
        switch (index % 5) {
            case 0:
                actionRender = new RBEightActionOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                actionRender = new RBEightActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new RBEightActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new RBEightActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new RBEightActionFive((int) mediaItem.getDuration(), width, height);
                break;
        }
...
//        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/rakshabandhan8_bg" + ConstantMediaSize.SUFFIX));
...
//        index = 0;
        switch (index % 5) {
            case 1:
                temp = new RBEightActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new RBEightActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new RBEightActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new RBEightActionFive((int) mediaItem.getDuration(), width, height);
                break;
            default:
                temp = new RBEightActionOne((int) mediaItem.getDuration(), width, height);
        }
