 ...
 * 最后在fragment中，重写计划
 */
public class WedEightDrawer implements IParticleRender {
    ...
    private WedEightSystem particleSystem;
    private long globalStartTime;
    private int[] textures = {-1, -1, -1, -1};
    private int[] textureLocations = {-1, -1, -1, -1};
    private static final String A_PARTICLE = "a_Paticle";
    private int particleLocation;

    public WedEightDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new WedEightSystem(8);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_eight_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_eight_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_eight_particle3" + ConstantMediaSize.SUFFIX));
        textures[3] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_eight_particle4" + ConstantMediaSize.SUFFIX));
