 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class VTTenThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new VTTenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new VTTenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new VTTenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new VTTenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new VTTenThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new VTTenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new VTTenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new VTTenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new VTTenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new VTTenThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
