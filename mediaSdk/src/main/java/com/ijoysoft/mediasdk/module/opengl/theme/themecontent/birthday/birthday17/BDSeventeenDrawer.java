 ...
 * 最后在fragment中，重写计划
 */
public class BDSeventeenDrawer implements IParticleRender {
    ...
    private BDSeventeenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDSeventeenSystem(4);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seventeen_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seventeen_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seventeen_particle3" + ConstantMediaSize.SUFFIX));
