...
public class MagicBlackCatFilter extends GPUImageFilter {
    ...
    public MagicBlackCatFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_blackcat));
    }
