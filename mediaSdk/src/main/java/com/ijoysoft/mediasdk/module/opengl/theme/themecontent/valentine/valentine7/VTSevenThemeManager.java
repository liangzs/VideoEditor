 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class VTSevenThemeManager extends BaseThemeManager {
...
//        index = 2;
        ...
        switch (index % 5) {
            case 0:
                actionRender = new VTSevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new VTSevenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new VTSevenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new VTSevenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new VTSevenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
...
//        index = 2;
        switch (index % 5) {
            case 0:
                temp = new VTSevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new VTSevenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new VTSevenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new VTSevenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new VTSevenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void initBackgroundTexture () {
        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_seven_theme_bg" + ConstantMediaSize.SUFFIX));
