...
public class VTSixSystem extends BaseParticleSystem {
    ...
    public VTSixSystem(int maxParticleCount) {
    ...
    private void updateParticle(int index) {
        ...
        if (origin - current < 0.5) {
            current = particles[currentOffset + 2] + 8;
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (4 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 5;//(20,25,30)
