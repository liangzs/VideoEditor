 ...
 * @ description
 */
public class LoveEightThemeFive extends BaseBlurThemeExample {
    ...
    public LoveEightThemeFive(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerY = width == height ? 0.77f : (width < height ? 0.88f : 0.73f);
