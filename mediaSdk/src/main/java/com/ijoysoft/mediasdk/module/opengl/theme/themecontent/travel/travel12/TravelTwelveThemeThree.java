 ...
 * @ description
 */
public class TravelTwelveThemeThree extends BaseBlurThemeExample {
    ...
    public TravelTwelveThemeThree(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centerX = width == height ? 0.73f : (width < height ? 0.66f : 0.85f);
