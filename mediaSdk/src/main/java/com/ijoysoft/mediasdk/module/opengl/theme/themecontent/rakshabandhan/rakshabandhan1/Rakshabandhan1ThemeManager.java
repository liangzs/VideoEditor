 ...
 * 兄妹节1
 */
public class Rakshabandhan1ThemeManager extends BaseThemeManager {
    ...
    public Rakshabandhan1ThemeManager() {
        super();
...
//        index=0;
        switch (index % 6) {
            case 0:
                actionRender = new RBOneActionOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                actionRender = new RBOneActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new RBOneActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new RBOneActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new RBOneActionFive((int) mediaItem.getDuration(), width, height);
                break;
            case 5:
                actionRender = new RBOneActionSix((int) mediaItem.getDuration(), width, height);
                break;
        }
...
//        bgImageFilter.setBackgroundTexture(BitmapFactory.decodeResource(MediaSdk.getInstance().getResouce(), R.mipmap.rb_bg));
        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/rb_bg" + ConstantMediaSize.SUFFIX));
...
//        index = 0;
        switch (index % 6) {
            case 1:
                temp = new RBOneActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new RBOneActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new RBOneActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new RBOneActionFive((int) mediaItem.getDuration(), width, height);
                break;
            case 5:
                temp = new RBOneActionSix((int) mediaItem.getDuration(), width, height);
                break;
            default:
                temp = new RBOneActionOne((int) mediaItem.getDuration(), width, height);
        }
