 ...
 * 最后在fragment中，重写计划
 */
public class VTSixDrawerTwo implements IParticleRender {
    ...
    private final String fragment = "precision mediump float; \n" +
            ...
            "    float nx=(cos(v_Paticle)*x - sin(v_Paticle )* y);\n" +
            "    float ny = (sin( v_Paticle )*x + cos( v_Paticle )*y);\n" +
    ...
    private VTSixSystemTwo particleSystem;
    private long globalStartTime;
    private int texture = -1;


    public VTSixDrawerTwo() {
        particleProgram = new ParticleShaderProgram(vertex, fragment);
        particleSystem = new VTSixSystemTwo(7);
    }
