 ...
 * 最后在fragment中，重写计划
 */
public class BabySevenDrawer implements IParticleRender {
    ...
    private BabySevenSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public BabySevenDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BabySevenSystem(9);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_seven_particle1" + ConstantMediaSize.SUFFIX));
    }
