 ...
 * @ description
 */
public class GreetThreeDrawer implements IParticleRender {
    ...
    private GreetThreeSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new GreetThreeSystem(10);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/greet_three_theme_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/greet_three_theme_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/greet_three_theme_particle3" + ConstantMediaSize.SUFFIX));
        textures[3] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/greet_three_theme_particle4" + ConstantMediaSize.SUFFIX));
