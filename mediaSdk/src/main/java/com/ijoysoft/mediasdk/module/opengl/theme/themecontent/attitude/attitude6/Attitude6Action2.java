 ...
 * 态度6
 */
public class Attitude6Action2 extends BaseBlurThemeTemplate {



    public Attitude6Action2(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //蓝色效果
                    {-1f, 0.5f, 0.3f, 0.6f, 0.6f},
                    //emoji
                    {0f, 0.75f, 3.6f, 4.8f, 3.6f}
            };
        }
        return widgetsMeta;
    }
