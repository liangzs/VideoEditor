 ...
 */
class ThemeContainWidget : BaseThemeExample(), IThemeClipAction {
    ...
    override fun creatClip(duration: Long, durationTriple: Triple<Int, Int, Int>) {
        BaseThemeExample(duration.toInt(), durationTriple.first, durationTriple.second, durationTriple.third)
    }
