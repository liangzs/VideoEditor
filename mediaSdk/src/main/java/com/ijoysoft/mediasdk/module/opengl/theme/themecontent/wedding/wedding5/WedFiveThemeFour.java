 ...
 * @ description
 */
public class WedFiveThemeFour extends BaseBlurThemeExample {
    ...
    public WedFiveThemeFour(int totalTime, boolean isNoZaxis, int width, int height) {
...
//        widgetOne.setOutAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setFade(1, 0).build());
        ...
        widgetTwo.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).
                setCoordinate(0, -1f, 0f, 0f).setIsNoZaxis(true).build());
...
//        widgetTwo.setOutAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setFade(1, 0).build());
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width == height ? 2f : (width < height ? 1.5f : 2.5f);
        float scaleY = width == height ? 2f : (width < height ? 1.5f : 2.5f);
        float centerX = width == height ? 0f : (width < height ? 0f : 0f);
        float centerY = width == height ? 0.9f : (width < height ? 0.9f : 0.8f);
        ...
        centerY = width == height ? -0.8f : (width < height ? -0.85f : -0.7f);
