 ...
 * @ description
 */
public class LoveTwoDrawer implements IParticleRender {
    ...
    private LoveTwoSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new LoveTwoSystem(5);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/love_two_theme_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/love_two_theme_particle2" + ConstantMediaSize.SUFFIX));
