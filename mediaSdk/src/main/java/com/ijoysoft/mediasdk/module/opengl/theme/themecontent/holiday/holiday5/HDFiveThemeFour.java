 ...
 * 缩小-放大-缩小
 */
public class HDFiveThemeFour extends BaseBlurThemeExample {
    ...
    public HDFiveThemeFour(int totalTime, boolean isNoZaxis) {
