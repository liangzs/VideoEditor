 ...
 * @ description
 */
public class LoveFourThemeOne extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public LoveFourThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width == height ? 2.8f : (width < height ? 1.8f : 3.5f);
        float scaleY = width == height ? 2.8f : (width < height ? 1.8f : 3.5f);
        ...
        scaleX = width == height ? 3f : (width < height ? 2f : 4f);
        scaleY = width == height ? 3f : (width < height ? 2f : 4f);
