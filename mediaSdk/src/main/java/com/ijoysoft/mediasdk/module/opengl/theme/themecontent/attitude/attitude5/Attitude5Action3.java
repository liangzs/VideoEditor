 ...
 * 态度5
 */
public class Attitude5Action3 extends BaseBlurThemeTemplate {


    public Attitude5Action3(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    ...
                    //emoji
                    {Float.MAX_VALUE, Float.MIN_VALUE, 2.5f, 2.5f, 2.5f}
            };
        }
        return widgetsMeta;
    }
