 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BabyFourThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BabyFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new BabyFourThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new BabyFourThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new BabyFourThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new BabyFourThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new BabyFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new BabyFourThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new BabyFourThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new BabyFourThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new BabyFourThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
