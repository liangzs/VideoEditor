 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class VTTwelveThemeManager extends BaseThemeManager {
...
//        index = 5;
        switch (index % 6) {
            case 0:
                actionRender = new VTTweleThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new VTTweleThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new VTTweleThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new VTTweleThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new VTTweleThemeFive((int) mediaItem.getDuration());
                break;
            case 5:
                actionRender = new VTTweleThemeSix((int) mediaItem.getDuration());
                break;
        }
...
//        index = 5;
        switch (index % 6) {
            case 0:
                temp = new VTTweleThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new VTTweleThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new VTTweleThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new VTTweleThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new VTTweleThemeFive((int) mediaItem.getDuration());
                break;
            case 5:
                temp = new VTTweleThemeSix((int) mediaItem.getDuration());
                break;
        }
    ...
    public void initBackgroundTexture () {
        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_twele_theme_bg" + ConstantMediaSize.SUFFIX));
