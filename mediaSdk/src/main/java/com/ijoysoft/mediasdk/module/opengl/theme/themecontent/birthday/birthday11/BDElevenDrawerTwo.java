 ...
 * 最后在fragment中，重写计划
 */
public class BDElevenDrawerTwo implements IParticleRender {
    ...
    private BDElevenSystemTwo particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDElevenSystemTwo(20);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_eleven_particle2" + ConstantMediaSize.SUFFIX));
