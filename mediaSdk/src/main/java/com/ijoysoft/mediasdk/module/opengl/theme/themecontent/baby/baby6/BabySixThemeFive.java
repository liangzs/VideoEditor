 ...
 * 这里在悬停缩放时，添加滤镜
 */
public class BabySixThemeFive extends BaseBlurThemeExample {
    ...
    public BabySixThemeFive(int totalTime, boolean isNoZaxis) {
        ...
        mBabySixCloudDrawer = new BabySixCloudDrawer(new BabySixCloudSystem(BabySixCloudSystem.FIVE));
    }
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleW = width <= height ? 3 : 6;
        scaleH = width <= height ? 6 : 3;
