...
public class MagicHealthyFilter extends GPUImageFilter {
    ...
    public MagicHealthyFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_healthy));
    }
    ...
    protected void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture("filter/healthy_mask_1.webp");
            }
        });
    }
