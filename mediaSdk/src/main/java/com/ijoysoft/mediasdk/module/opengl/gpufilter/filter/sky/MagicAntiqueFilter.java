...
/**
 * mStrength1Value = 0.85098
 * 复古
 */
public class MagicAntiqueFilter extends GPUImageFilter {
    private int[] mToneCurveTexture = {-1};
    private int mToneCurveTextureUniformLocation;
    private int mStrength1UniformLocation;
    private float mStrength1Value;

    public MagicAntiqueFilter(MagicFilterType magicFilterType, float mStrength1Value) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_antique));
        this.mStrength1Value = mStrength1Value;
    }
    ...
    protected void onInit() {
        ...
        mStrength1UniformLocation = GLES20.glGetUniformLocation(mGLProgId, "strength1");
    }

    @Override
    protected void onInitialized() {
        setFloat(mStrength1UniformLocation, mStrength1Value);
