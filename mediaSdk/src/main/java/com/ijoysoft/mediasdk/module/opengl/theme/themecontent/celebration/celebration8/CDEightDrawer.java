 ...
 * 飘雪
 */
public class CDEightDrawer implements IParticleRender {
    ...
    private CDEightSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new CDEightSystem(40);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/cd_eight_particle1" + ConstantMediaSize.SUFFIX));
