 ...
 * 生日24
 */
public class Birthday24Action4 extends BaseBlurThemeTemplate {



    public Birthday24Action4(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //粉色效果
                    {1f, -0.5f, 0.6f, 0.6f, 0.6f},
                    //黄色效果
                    {-1f, 0f, 0.6f, 0.6f, 0.6f},
                    //戴帽子的emoji
