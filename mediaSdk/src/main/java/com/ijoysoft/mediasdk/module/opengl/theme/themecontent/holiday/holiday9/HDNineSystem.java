 ...
 */
public class HDNineSystem extends BaseParticleSystem {
    ...
    public void addParticleImpl(int index) {
        ...
        particles[currentOffset++] = (1 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 20;//大小
        particles[currentOffset++] = 0f;//alpha
        particles[currentOffset++] = random.nextInt(3);//textureType
        particles[currentOffset++] = 0;
