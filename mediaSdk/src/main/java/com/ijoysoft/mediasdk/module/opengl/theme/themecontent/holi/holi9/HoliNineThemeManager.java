 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HoliNineThemeManager extends BaseThemeManager {
    ...
    public void drawPrepare(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                actionRender = new HoliNineThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new HoliNineThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new HoliNineThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                actionRender = new HoliNineThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new HoliNineThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        bgImageFilter.draw();
    ...
    public IAction getNextAction(MediaItem mediaItem, int index) {
        ...
        switch (index % 5) {
            case 0:
                temp = new HoliNineThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new HoliNineThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new HoliNineThemeThree((int) mediaItem.getDuration(), width, height, true);
                break;
            case 3:
                temp = new HoliNineThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new HoliNineThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
