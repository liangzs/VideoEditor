 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDNineThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BirthDayNineThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BirthDayNineThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new BirthDayNineThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new BirthDayNineThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new BirthDayNineThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new BirthDayNineThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new BirthDayNineThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new BirthDayNineThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new BirthDayNineThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new BirthDayNineThemeFive((int) mediaItem.getDuration());
                break;
        }
