...
public class WedEightSystem extends BaseParticleSystem {
    ...
    public WedEightSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = (2 + random.nextInt(4)) * ConstantMediaSize.getMinWH() / 5;//(20,25,30)
        if (isInit) {
        ...
        particles[currentOffset++] = random.nextInt(4) * 1f;
        vertexArray.updateBuffer(particles, particleOffset, TOTAL_COUNT);
    }
