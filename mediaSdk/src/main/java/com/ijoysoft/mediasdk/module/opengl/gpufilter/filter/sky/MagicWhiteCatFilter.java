...
public class MagicWhiteCatFilter extends GPUImageFilter {
    ...
    public MagicWhiteCatFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_whitecat));
    }
