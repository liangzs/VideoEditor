 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HDOneThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new HDOneThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new HDOneThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new HDOneThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new HDOneThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new HDOneThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new HDOneThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new HDOneThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new HDOneThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new HDOneThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new HDOneThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
