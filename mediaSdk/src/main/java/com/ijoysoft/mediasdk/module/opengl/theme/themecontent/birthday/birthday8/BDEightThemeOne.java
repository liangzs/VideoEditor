 ...
 * 上进，上下悬停，左划出
 */
public class BDEightThemeOne extends BaseThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BDEightStarClusterDrawer starClusterDrawer;

    public BDEightThemeOne(int totalTime) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 2 : (width == height ? 2 : 2);
        centerX = width < height ? -0.3f : (width == height ? -0.3f : -0.4f);
