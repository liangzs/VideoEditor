 ...
 * 缩小-放大-缩小
 */
public class CDEightThemeFour extends BaseBlurThemeExample {

    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public CDEightThemeFour(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centery = width < height ? -0.95f : (width == height ? -0.9f : -0.85f);
