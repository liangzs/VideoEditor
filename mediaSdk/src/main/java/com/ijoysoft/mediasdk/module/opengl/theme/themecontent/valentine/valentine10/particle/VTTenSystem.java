...
public class VTTenSystem extends BaseParticleSystem {
    ...
    public VTTenSystem(int maxParticleCount) {
    ...
    public void addParticle(float particleStartTime) {
        pointSize = Math.min(ConstantMediaSize.showViewWidth, ConstantMediaSize.getMinWH()) / 60;
