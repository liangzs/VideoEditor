...
public class MagicNostalgiaFilter extends GPUImageFilter {
    ...
    public MagicNostalgiaFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_nostalgia));
    }
    ...
    public void onInitialized() {
        setFloat(mBlurSizeUniformLocation, 1.0F);
        runOnDraw(new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < 256; i++) {
                    arrayOfByte1[(i * 4)] = ((byte) arrayOfInt1[i]);
                ...
                for (int j = 0; j < 256; j++) {
                    arrayOfByte1[((1024 + j * 4))] = ((byte) arrayOfInt5[j]);
                ...
                for (int k = 0; k < 256; k++) {
                    arrayOfByte2[(k * 4)] = ((byte) arrayOfInt9[k]);
