 ...
 * 朋友3
 */
public class Friend3Action4 extends BaseBlurThemeTemplate {



    public Friend3Action4(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //红
                    {-0.9f, -0.75f, 0.3f, 0.3f, 0.3f},
                    //蓝
                    {0.9f, 0.85f, 0.3f, 0.3f, 0.3f},
                    //标题
                    {0f, 0.7f, 1.6f, 3.2f, 1.6f},
            };
        }
        return widgetsMeta;
    }
