 ...
 * 最后在fragment中，重写计划
 */
public class WedTenDrawerOne implements IParticleRender {
    ...
    private WedTenSystemOne particleSystem;
    private long globalStartTime;
    private int texture;

    public WedTenDrawerOne() {
        particleProgram = new ParticleShaderProgram(vertex, fragment);
        particleSystem = new WedTenSystemOne(6);
    }
