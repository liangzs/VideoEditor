 ...
 * 上进，上下悬停，左划出
 */
public class WeddingActionTwo extends BaseThemeExample {

    public WeddingActionTwo(int totalTime) {
        ...
        outAnimation = new AnimationBuilder(DEFAULT_OUT_TIME).setCoordinate(0, 0f, 2.5f, 0).
                setConors(AnimateInfo.ROTATION.Y_ANXIS, 0, 180).setZView(WeddingOneThemeManager.Z_VIEW).build();
    }
