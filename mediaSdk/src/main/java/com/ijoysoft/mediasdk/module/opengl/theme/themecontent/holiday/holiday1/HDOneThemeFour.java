 ...
 * 缩小-放大-缩小
 */
public class HDOneThemeFour extends BaseBlurThemeExample {
    ...
    public HDOneThemeFour(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width < height ? 3 : 2;
        widgetTwo.init(mimaps.get(2), width, height);
        originOne = widgetTwo.adjustScaling(width, height / 2, mimaps.get(2).getWidth(), mimaps.get(2).getHeight(), AnimateInfo.ORIENTATION.BOTTOM, scaleX);
