...
public class BDSixThemeFour extends BaseBlurThemeExample {

    private BaseThemeExample widgetOne;

    public BDSixThemeFour(int totalTime) {
        ...
        widgetOne.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).
                setCoordinate(0, -1f, 0, 0).setIsWidget(true).setIsNoZaxis(true).build());
