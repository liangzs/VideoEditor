...
public class WidgetOneFlowerSystem extends BaseParticleSystem {
        ...
        for (int i = 0; i < flowerNum; i++) {
            ...
            switch (i) {
                case 0:
                    ...
                    break;
                case 1:
                    position = new Geometry.Point(-0.35f, 0.85f, 0f);
                    particles[currentOffset + 1] = 20 + ConstantMediaSize.getMinWH() / 5;
                    break;
                case 2:
                    position = new Geometry.Point(-0.5f, 0.9f, 0f);
                    break;
                case 3:
                    position = new Geometry.Point(0.4f, -0.9f, 0f);
                    break;
                case 4:
                    position = new Geometry.Point(0.6f, -0.85f, 0f);
                    break;
                case 5:
                    position = new Geometry.Point(0.8f, -0.75f, 0f);
                    break;
                default:
