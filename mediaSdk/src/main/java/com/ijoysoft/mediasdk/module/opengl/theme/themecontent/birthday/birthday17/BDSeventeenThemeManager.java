 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDSeventeenThemeManager extends BaseThemeManager {
...
//        index = 5;
        switch (index % 6) {
            case 0:
                actionRender = new BDSeventeenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new BDSeventeenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new BDSeventeenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new BDSeventeenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new BDSeventeenThemeFive((int) mediaItem.getDuration(), true);
                break;
            case 5:
                actionRender = new BDSeventeenThemeSix((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 5;
        ...
        switch (index % 6) {
            case 0:
                temp = new BDSeventeenThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new BDSeventeenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new BDSeventeenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new BDSeventeenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new BDSeventeenThemeFive((int) mediaItem.getDuration(), true);
                break;
            case 5:
                temp = new BDSeventeenThemeSix((int) mediaItem.getDuration(), true);
                break;
        }
