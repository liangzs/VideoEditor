 ...
 * 最后在fragment中，重写计划
 */
public class VTTenDrawer implements IParticleRender {
    ...
    private VTTenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTTenSystem(10);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_ten_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_ten_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_ten_particle3" + ConstantMediaSize.SUFFIX));
