...
public class VTOneSystemTwo extends BaseParticleSystem {
    ...
    public VTOneSystemTwo(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (2 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 30;//(20,25,30)
