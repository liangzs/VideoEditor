 ...
 * stay 缩小
 */
public class VTFourteenThemeThree extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;
    private BaseThemeExample widgetFour;

    public VTFourteenThemeThree(int totalTime, boolean isNoZaxis, int width, int height) {
