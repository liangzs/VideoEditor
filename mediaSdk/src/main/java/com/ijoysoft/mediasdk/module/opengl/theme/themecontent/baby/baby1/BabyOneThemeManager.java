 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BabyOneThemeManager extends BaseThemeManager {
...
//        index = 0;
        switch (index % 5) {
            case 0:
                actionRender = new BabyOneThemeOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                actionRender = new BabyOneThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new BabyOneThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new BabyOneThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new BabyOneThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_one_theme_bg" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_one_bg169" + ConstantMediaSize.SUFFIX));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_one_bg11" + ConstantMediaSize.SUFFIX));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_one_theme_bg" + ConstantMediaSize.SUFFIX));
                break;
...
//        index = 0;
        switch (index % 5) {
            case 0:
                temp = new BabyOneThemeOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                temp = new BabyOneThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new BabyOneThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new BabyOneThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new BabyOneThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
