 ...
 */
public class RandomFadeDrawer implements IParticleRender {
    ...
    private RandomFadeSystem particleSystem;
    ...
    void init(List<Bitmap> bitmaps) {
        ...
        buildFragment();
        LogUtils.i(getClass().getSimpleName(), "RandomFadeDrawer Createrd, size: " + bitmaps.size());
...
//        LogUtils.i(getClass().getSimpleName(), "GLSL: \n" + fragment);
    ...
    protected void onDrawPreview() {
        ...
        for (int i = 0; i < textures.length
            ...
            GLES20.glUniform1i(textureLocations[i], i + 1);
        }
    }
...
//        LogUtils.i(getClass().getSimpleName(), "draw");
    ...
    public void setParticleSystem(RandomFadeSystem particleSystem) {
