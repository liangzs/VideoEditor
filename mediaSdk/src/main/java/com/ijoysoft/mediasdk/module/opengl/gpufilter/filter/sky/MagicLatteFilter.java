...
public class MagicLatteFilter extends GPUImageFilter {
    ...
    public MagicLatteFilter(MagicFilterType magicFilterType, float mStrength1Value) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_latte));
