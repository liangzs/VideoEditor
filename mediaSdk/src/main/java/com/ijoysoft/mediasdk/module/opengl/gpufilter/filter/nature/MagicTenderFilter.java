...
public class MagicTenderFilter extends GPUImageFilter {
    ...
    public MagicTenderFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_tender));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture("filter/bluevintage_mask1.webp");
            }
        });
    }
