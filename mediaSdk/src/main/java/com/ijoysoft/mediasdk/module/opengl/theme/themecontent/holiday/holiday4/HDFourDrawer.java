 ...
 * 最后在fragment中，重写计划
 */
public class HDFourDrawer implements IParticleRender {
    ...
    private HDFourSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDFourSystem(6);
        globalStartTime = System.currentTimeMillis();

        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_four_particle" + ConstantMediaSize.SUFFIX));
