 ...
 * 朋友3
 */
public class Friend3Action3 extends BaseBlurThemeTemplate {




    public Friend3Action3(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    //红
                    {-1f, -0.2f, 0.3f, 0.3f, 0.3f},
                    //蓝
                    {1f, 0.2f, 0.3f, 0.3f, 0.3f},
                    //标题
                    {0f, 0.7f, 1.4f, 2.8f, 1.4f},
            };
        }
        return widgetsMeta;
    }
