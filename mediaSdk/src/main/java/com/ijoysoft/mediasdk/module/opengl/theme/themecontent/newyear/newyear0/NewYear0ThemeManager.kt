package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.newyear.newyear0
...
class NewYear0ThemeManager: BaseTimeThemeManager() {
//    override fun createWidgetByIndex(index: Int) = if (index == 0) {
//        ThemeWidgetInfo(5250, 0, 0, 0, 5250)
//    } else {
//        ThemeWidgetInfo(5250, 0, 0, 5250, 10500)
//    }
