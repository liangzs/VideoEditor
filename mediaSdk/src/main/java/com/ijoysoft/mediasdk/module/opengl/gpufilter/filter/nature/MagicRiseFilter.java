...
public class MagicRiseFilter extends GPUImageFilter {
    ...
    public MagicRiseFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_rise));
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = OpenGlUtils.loadTexture("filter/blackboard1024.webp");
