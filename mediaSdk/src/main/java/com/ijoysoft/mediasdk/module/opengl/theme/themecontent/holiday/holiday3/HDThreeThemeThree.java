 ...
 * stay 缩小
 */
public class HDThreeThemeThree extends BaseBlurThemeExample {
    ...
    public HDThreeThemeThree(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleW = width < height ? 5f : (width == height ? 5 : 4);
