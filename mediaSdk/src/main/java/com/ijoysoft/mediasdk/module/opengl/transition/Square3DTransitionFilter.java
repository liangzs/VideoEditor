 ...
 */
public class Square3DTransitionFilter extends TransitionFilter {

    private int mPrograssLocation;

    public Square3DTransitionFilter(TransitionType transitionType) {
        super(transitionType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.transition_square_3d));
    }
