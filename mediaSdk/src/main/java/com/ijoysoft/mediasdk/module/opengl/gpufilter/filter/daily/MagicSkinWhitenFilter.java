...
public class MagicSkinWhitenFilter extends GPUImageFilter {
    ...
    public MagicSkinWhitenFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_skinwhiten));
    }

    public void onInit() {
        super.onInit();
        mToneCurveTextureUniformLocation = GLES20.glGetUniformLocation(mGLProgId, "curve");
        mTexelWidthUniformLocation = GLES20.glGetUniformLocation(mGLProgId, "texelWidthOffset");
        mTexelHeightUniformLocation = GLES20.glGetUniformLocation(mGLProgId, "texelHeightOffset");
    }
...
//        return GpuFilterFactory.NAME_SKIN_WHITEN;
//    }
}
