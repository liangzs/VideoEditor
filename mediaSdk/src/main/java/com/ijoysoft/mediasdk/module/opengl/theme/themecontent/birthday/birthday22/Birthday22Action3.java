 ...
 * 生日22
 */
public class Birthday22Action3 extends BaseBlurThemeTemplate {


    public Birthday22Action3(int totalTime, int width, int height) {
    ...
    public void initWidget() {
        ...
        widgets[3] = buildNewCoordinateTemplateAnimate(AnimateInfo.ORIENTATION.TOP, AnimateInfo.ORIENTATION.TOP);
