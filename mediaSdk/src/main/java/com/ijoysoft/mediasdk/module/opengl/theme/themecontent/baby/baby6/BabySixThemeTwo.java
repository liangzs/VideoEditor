 ...
 * stay 放大-缩小-放大
 */
public class BabySixThemeTwo extends BaseBlurThemeExample {
    ...
    public BabySixThemeTwo(int totalTime, boolean isNoZaxis) {
        ...
        mBabySixCloudDrawer = new BabySixCloudDrawer(new BabySixCloudSystem(BabySixCloudSystem.TWO));
    }
