 ...
 * 最后在fragment中，重写计划
 */
public class VTFourteenDrawer implements IParticleRender {
    ...
    private VTFourteenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTFourteenSystem(6);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_fourteen_particle3" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_fourteen_particle1" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_fourteen_particle2" + ConstantMediaSize.SUFFIX));
