 ...
 * 这里在悬停缩放时，添加滤镜
 */
public class BabySixThemeOne extends BaseBlurThemeExample {
    ...
    public BabySixThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
        ...
        mBabySixCloudDrawer = new BabySixCloudDrawer(new BabySixCloudSystem(BabySixCloudSystem.ONE));
    }
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //文字
        float centerx = width <= height ? 0.3f : 0.0f;
