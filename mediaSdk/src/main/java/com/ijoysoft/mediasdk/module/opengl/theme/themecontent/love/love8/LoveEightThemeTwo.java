 ...
 * @ description
 */
public class LoveEightThemeTwo extends BaseBlurThemeExample {
    private BaseThemeExample widgetBorder;
    private BaseThemeExample widgetOne;

    public LoveEightThemeTwo(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerX = width == height ? 0.72f : (width < height ? 0.69f : 0.83f);
        float centerY = width == height ? 0.72f : (width < height ? 0.83f : 0.73f);
