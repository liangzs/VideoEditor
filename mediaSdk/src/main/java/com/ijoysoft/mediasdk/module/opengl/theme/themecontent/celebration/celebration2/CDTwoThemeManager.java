 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class CDTwoThemeManager extends BaseThemeManager {
...
//        index = 0;
        switch (index % 5) {
            case 0:
                actionRender = new CDTwoThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new CDTwoThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new CDTwoThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new CDTwoThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new CDTwoThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 0;
        ...
        switch (index % 5) {
            case 0:
                temp = new CDTwoThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new CDTwoThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new CDTwoThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new CDTwoThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new CDTwoThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
