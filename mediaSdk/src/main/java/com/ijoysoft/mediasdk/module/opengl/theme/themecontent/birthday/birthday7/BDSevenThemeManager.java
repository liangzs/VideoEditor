 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDSevenThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BDSevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BDSevenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new BDSevenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new BDSevenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new BDSevenThemeFive((int) mediaItem.getDuration());
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seven_bg11" + ConstantMediaSize.SUFFIX));
                break;
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seven_bg916" + ConstantMediaSize.SUFFIX));
                break;
            case _4_3:
            case _16_9:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seven_bg169" + ConstantMediaSize.SUFFIX));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seven_bg916" + ConstantMediaSize.SUFFIX));
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new BDSevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new BDSevenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new BDSevenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new BDSevenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new BDSevenThemeFive((int) mediaItem.getDuration());
                break;
        }
