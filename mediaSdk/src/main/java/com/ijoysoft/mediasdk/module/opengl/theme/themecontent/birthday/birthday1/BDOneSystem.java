...
public class BDOneSystem extends BaseParticleSystem {
    ...
    public BDOneSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (1 + random.nextInt(3)) * ConstantMediaSize.showViewWidth / 30;//(20,25,30)
