 ...
 * EGL 相关配置
 */
public class RealTimeEGLManager {

    private static final String TAG = RealTimeEGLManager.class.getSimpleName();
    //
     ...
     * @param eglContext
     */
    public RealTimeEGLManager(final EGLContext eglContext, final Object surface) {
