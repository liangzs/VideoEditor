 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class TravelTwelveThemeManager extends BaseThemeManager {

    private int width, height;
    private int offsetX, offsetY;

    //由于bitmap的处理比较延迟，所以在对象初始化的时候把这些数据准备好，以防用到时卡动画
    public TravelTwelveThemeManager() {
        super();
    }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new TravelTwelveThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new TravelTwelveThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                actionRender = new TravelTwelveThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                actionRender = new TravelTwelveThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
            case 4:
                actionRender = new TravelTwelveThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new TravelTwelveThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new TravelTwelveThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                temp = new TravelTwelveThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                temp = new TravelTwelveThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
            case 4:
                temp = new TravelTwelveThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
