...
public class BDSixteenThemeOne extends BaseBlurThemeExample {
    ...
    public BDSixteenThemeOne(int totalTime, boolean isNoZias) {
        super(totalTime, DEFAULT_ENTER_TIME, 3000, DEFAULT_OUT_TIME, isNoZias);
    ...
    public void initWidget() {
        ...
        widgetFive.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setOrientation(AnimateInfo.ORIENTATION.TOP).setIsNoZaxis(true).
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 5 : (width == height ? 4 : 4);
        centerX = width < height ? -0.65f : (width == height ? -0.7f : -0.75f);
        centerY = width < height ? -0.65f : (width == height ? -0.65f : -0.65f);
        ...
        centerY = width < height ? -0.68f : (width == height ? -0.62f : -0.6f);
