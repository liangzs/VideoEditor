 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class LoveSixThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new LoveSixThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new LoveSixThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                actionRender = new LoveSixThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                actionRender = new LoveSixThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
            case 4:
                actionRender = new LoveSixThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new LoveSixThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new LoveSixThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                temp = new LoveSixThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                temp = new LoveSixThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
            case 4:
                temp = new LoveSixThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
