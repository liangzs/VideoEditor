 ...
 * stay 放大-缩小
 */
public class LoveFourteenThemeTwo extends BaseBlurThemeExample {

    private ParticleDefaultDrawer particleDefaultDrawer;

    public LoveFourteenThemeTwo(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float[][] coord = new float[][]{{-0.85f, -0.85f}, {0, -0.85f}, {0.85f, -0.85f}
                , {-0.85f, 0.85f}, {0, 0.85f}, {0.85f, 0.85f}};
