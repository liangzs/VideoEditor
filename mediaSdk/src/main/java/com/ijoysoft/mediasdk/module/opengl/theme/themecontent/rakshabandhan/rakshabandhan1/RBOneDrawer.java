 ...
 * 最后在fragment中，重写计划
 */
public class RBOneDrawer implements IParticleRender {
    ...
    private final String vertex = "uniform mat4 u_Matrix;\n" +
            ...
            "    vec3 currentPosition = a_Position;\n"+ //+ (a_DirectionVector * v_ElapsedTime);\n" +
...
//            "   if(v_Paticle==0.0){\n" +
            "       gl_FragColor=texture2D(u_Texture2, vec2( x+0.5,y+0.5)) * vec4(0.93, 0.9, 0.465, 0);\n" +
...
//            "    }\n" +
    ...
    private RBOneSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new RBOneSystem(32);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/rb_bg" + ConstantMediaSize.SUFFIX));

        textureLocation = GLES20.glGetUniformLocation(particleProgram.getPrograram(), "u_Texture2");
    ...
    protected void onDrawPreview() {
            ...
            GLES20.glUniform1i(textureLocation, 3);
    }
