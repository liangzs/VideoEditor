 ...
 * 最后在fragment中，重写计划
 */
public class TravelSixDrawer implements IParticleRender {
    ...
    private TravelSixSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new TravelSixSystem(4);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_six_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/travel_six_particle2" + ConstantMediaSize.SUFFIX));
