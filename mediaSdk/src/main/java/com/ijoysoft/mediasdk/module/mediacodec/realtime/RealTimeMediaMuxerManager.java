...
public class RealTimeMediaMuxerManager {

    private static final String TAG = RealTimeMediaMuxerManager.class.getSimpleName();
    ...
    public RealTimeMediaMuxerManager() throws IOException {
        try {
            // 输出文件路径
//            mOutputPath = getCaptureFile(ext).toString();
//            mOutputPath = ConstantPath.MURGE_TEST;
            //
