...
public class CDTwoSystem extends BaseParticleSystem {
    ...
    public CDTwoSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = (4 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 70;//(20,25,30)
        if (isInit) {
            particles[currentOffset++] = temp;
        } else {
