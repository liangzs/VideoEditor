 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDFifteenThemeManager extends BaseThemeManager {
...
//        index = 5;
        switch (index % 6) {
            case 0:
                actionRender = new BDFifteenThemeOne((int) mediaItem.getDuration(), true);
                break;
            case 1:
                actionRender = new BDFifteenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new BDFifteenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new BDFifteenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new BDFifteenThemeFive((int) mediaItem.getDuration(), true);
                break;
            case 5:
                actionRender = new BDFifteenThemeSix((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 5;
        switch (index % 6) {
            case 0:
                temp = new BDFifteenThemeOne((int) mediaItem.getDuration(), true);
                break;
            case 1:
                temp = new BDFifteenThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new BDFifteenThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new BDFifteenThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new BDFifteenThemeFive((int) mediaItem.getDuration(), true);
                break;
            case 5:
                temp = new BDFifteenThemeSix((int) mediaItem.getDuration(), true);
                break;
        }
