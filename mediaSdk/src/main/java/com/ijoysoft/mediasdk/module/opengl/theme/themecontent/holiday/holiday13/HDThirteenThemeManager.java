 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HDThirteenThemeManager extends BaseThemeManager {
    /**
     * 创建缓存对象，离屏buffer
     */
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new HDThirteenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new HDThirteenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new HDThirteenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new HDThirteenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new HDThirteenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        switch (ConstantMediaSize.ratioType) {
            case _9_16:
            case _3_4:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_thirteen_theme916_bg" + ConstantMediaSize.SUFFIX));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_thirteen_theme11_bg" + ConstantMediaSize.SUFFIX));
                break;
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_thirteen_theme169_bg" + ConstantMediaSize.SUFFIX));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_thirteen_theme916_bg" + ConstantMediaSize.SUFFIX));
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new HDThirteenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new HDThirteenThemeTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new HDThirteenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new HDThirteenThemeFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new HDThirteenThemeFive((int) mediaItem.getDuration(), width, height);
                break;
        }
