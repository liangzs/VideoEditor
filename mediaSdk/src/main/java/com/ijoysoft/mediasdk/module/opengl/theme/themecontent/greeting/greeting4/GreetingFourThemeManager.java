 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class GreetingFourThemeManager extends BaseThemeManager {
...
//        index = 3;
        ...
        switch (index % 4) {
            case 0:
                actionRender = new GreetFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new GreetFourThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                actionRender = new GreetFourThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                actionRender = new GreetFourThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 3;
        ...
        switch (index % 4) {
            case 0:
                temp = new GreetFourThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new GreetFourThemeTwo((int) mediaItem.getDuration(), true, width, height);
                break;
            case 2:
                temp = new GreetFourThemeThree((int) mediaItem.getDuration(), true, width, height);
                break;
            case 3:
                temp = new GreetFourThemeFour((int) mediaItem.getDuration(), true, width, height);
                break;
        }
