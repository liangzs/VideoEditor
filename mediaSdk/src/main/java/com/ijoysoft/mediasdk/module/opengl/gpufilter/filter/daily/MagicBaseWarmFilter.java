...
/**
 * 温暖Base
 * 修改mWarmValueUniformLocation值可以创造不同的滤镜，正常值为：0.6
 */
public class MagicBaseWarmFilter extends GPUImageFilter {
    ...
    protected int mWarmValueUniformLocation;

    public MagicBaseWarmFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_warm));
    }
    ...
    public void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(mGLProgId, "layerImage");
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(mGLProgId, "greyFrame");
        mWarmValueUniformLocation = GLES20.glGetUniformLocation(mGLProgId, "warmValue");
    }
    ...
    public void onInitialized() {
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/warm_layer1.webp");
                mMaskGrey2TextureId = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/bluevintage_mask1.webp");
            }
        });
    }
