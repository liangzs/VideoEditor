 ...
 */
public class BDEightteenBaseExample extends BaseThemeExample {

    protected int weightTime;
    protected BaseEvaluate stayNext;
    protected int stayNextCount;

    public BDEightteenBaseExample(int duration, int enterTime, int stayTime, int stayNex, int outTime) {
