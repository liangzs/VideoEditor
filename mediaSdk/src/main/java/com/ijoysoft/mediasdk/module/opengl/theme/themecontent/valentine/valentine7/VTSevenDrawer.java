 ...
 * 最后在fragment中，重写计划
 */
public class VTSevenDrawer implements IParticleRender {
    ...
    private final String fragment = "precision mediump float; \n" +
            ...
            "    float nx=(cos(180.0)*x - sin(180.0)* y);\n" +
            "    float ny = (sin(180.0)*x + cos( 180.0)*y);\n" +
            "   if(v_Paticle==0.0){\n" +
    ...
    private VTSevenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new VTSevenSystem(6);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_seven_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_seven_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/vt_seven_particle3" + ConstantMediaSize.SUFFIX));
    ...
    protected void onDrawPreview() {
        for (int i = 0; i < textures.length
            ...
            GLES20.glUniform1i(textureLocations[i], (i));
        }
    }
