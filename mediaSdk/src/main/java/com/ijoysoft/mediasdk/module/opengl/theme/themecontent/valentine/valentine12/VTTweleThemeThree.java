 ...
 * //TODO 换成控件方案
 */
public class VTTweleThemeThree extends BaseThemeExample {
    ...
    public VTTweleThemeThree(int totalTime) {
        ...
        enterAnimation = new WaveAnimation(new AnimationBuilder(DEFAULT_OUT_TIME).
                setCoordinate(2.5f, 0f, 0, -0.0f).setZView(-2.5f));
        outAnimation = new AnimationBuilder(DEFAULT_OUT_TIME).
                setCoordinate(0f, 0f, 0f, 2.5f).setZView(-2.5f).build();
        setZView(-2.5f);
    }
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerX = 0.0f;
        float centerY = 0.9f;
        float scaleX = width < height ? 2f : 4;
        float scaleY = width < height ? 4f : 2;
        ...
        scaleX = width < height ? 2f : 4;
        scaleY = width < height ? 4f : 2;
