...
//    };
    ...
    public TextureRender(VideoInfo info) {
        ...
        mBeFilter = new DoodleGroupFilter();
        //默认加上水印 可以取消掉
//        WaterMarkFilter waterMarkFilter = new WaterMarkFilter();
//        OpenGlUtils.loadTexture(BitmapFactory.decodeResource(resources, R.drawable.expression1), -1);
//
//        waterMarkFilter.setPosition(0, 70, 0, 0);
//        mBeFilter.addDoodle(waterMarkFilter);
