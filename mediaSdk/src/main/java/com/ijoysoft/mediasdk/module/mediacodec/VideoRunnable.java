...
//import com.ijoysoft.mediasdk.module.entity.MediaCodecInfo;
...
//
//        OutputSurface outputSurface = new OutputSurface(new ArrayList<DoodleItem>(), null, null);  // TODO: 2019/7/8 涂鸦列表？
//
...
//                LogUtils.e("videoo", "---解码器 是否可用  " + inputIndex);
//                if (inputIndex >= 0) {
//                    /*说明解码器有可用的ByteBuffer*/
...
//                LogUtils.e("videoo", "  解码器出来的index   " + outputIndex);
...
//                        outputSurface.drawImage(false, 0, 0);
...
//
//                    } else {
//                        LogUtils.e("videoo", "---解码出来的视频有问题=== " + doRender + "   " + isUseful);
//                    }
...
//                            isChangeVideo = true;
//                            isNextStep = true;
//                            LogUtils.e("videoo", "---更换分离器 and 解码器---==");
//                        } else {
//                            /*没有数据了 就给编码器发送一个结束的标志位*/
//                            videoEncoder.signalEndOfInputStream();
//                            inputDone = true;
//                            LogUtils.e("videoo", "---所有视频都解码完成了 告诉编码器 可以结束了---==");
//                        }
//                    }
//                }
//                /*
...
//                        LogUtils.e("videoo", "---添加MediaFormat");
...
//                            LogUtils.e("videoo", "--写入混合器的数据----presentationTime===" + encodeOutputInfo.presentationTimeUs + "===size===" + encodeOutputInfo.size + "----flags==" + encodeOutputInfo.flags);
...
//        LogUtils.e("timee", "---视频编码完成---视频编码耗时-==" + (end - start));
//    }
//
//
