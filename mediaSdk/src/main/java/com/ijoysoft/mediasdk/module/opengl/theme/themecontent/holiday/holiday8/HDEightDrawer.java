 ...
 * 全局烟花
 */
public class HDEightDrawer implements IParticleRender {
    ...
    private HDEightSystem particleSystem;
    private long globalStartTime;
    private int[] textures;
    private int[] textureLocations;


    public HDEightDrawer() {
        particleSystem = new HDEightSystem();
    }
    ...
    public void onSurfaceCreated() {
        onDrawAfter();
        textures = new int[4];
        textureLocations = new int[4];
        particleProgram = new ParticleShaderProgram(VERTEX, FRAGMENT);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_particle3" + ConstantMediaSize.SUFFIX));
        textures[3] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_particle4" + ConstantMediaSize.SUFFIX));
