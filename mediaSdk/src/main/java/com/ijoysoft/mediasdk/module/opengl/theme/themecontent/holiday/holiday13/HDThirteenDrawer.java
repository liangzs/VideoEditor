 ...
 * 最后在fragment中，重写计划
 */
public class HDThirteenDrawer implements IParticleRender {
    ...
    private HDThirteenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDThirteenSystem(12);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirteen_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_thirteen_particle2" + ConstantMediaSize.SUFFIX));
