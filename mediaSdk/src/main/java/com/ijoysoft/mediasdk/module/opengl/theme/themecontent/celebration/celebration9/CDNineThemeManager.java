 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class CDNineThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new CDNineThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new CDNineThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new CDNineThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new CDNineThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new CDNineThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new CDNineThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new CDNineThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new CDNineThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new CDNineThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new CDNineThemeFive((int) mediaItem.getDuration(), true, width, height);
                break;
        }
