 ...
 * 最后在fragment中，重写计划
 */
public class BDSevenDrawerOne implements IParticleRender {
    ...
    private BDSevenSystemOne particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDSevenSystemOne(10);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_seven_particle2" + ConstantMediaSize.SUFFIX));
