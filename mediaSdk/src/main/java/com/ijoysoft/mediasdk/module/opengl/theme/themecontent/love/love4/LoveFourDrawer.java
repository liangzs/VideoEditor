 ...
 * @ description
 */
public class LoveFourDrawer implements IParticleRender {
    ...
    private LoveFourSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new LoveFourSystem(6);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/love_four_theme_particle1" + ConstantMediaSize.SUFFIX));
