 ...
 * stay 缩小
 */
public class BDSeventeenThemeSix extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;


    public BDSeventeenThemeSix(int totalTime, boolean isNoZaxis) {
        ...
        outAnimation = new EnterEvaluateEaseOut(new AnimationBuilder(DEFAULT_ENTER_TIME).setCoordinate(0f, 0f, 2f, 0f).
...
//        starClusterDrawer = new StarClusterDrawer(new BDFiveStarSystemOne());
    ...
    public void initWidget() {
        ...
        widgetTwo = new BaseThemeExample(totalTime, 1500, 2000, DEFAULT_OUT_TIME, true);
        widgetTwo.setStayAction(new AnimationBuilder(totalTime).setZView(0).setIsNoZaxis(true).
                setCoordinate(0, 2.5f, 0f, -1.5f).build());
        widgetTwo.setZView(-0.0f);

        widgetThree = new BaseThemeExample(totalTime, 2000, 2000, DEFAULT_OUT_TIME, true);
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 8 : (width == height ? 8 : 6);
        centerX = -0.7f;
        centerY = -1.4f;
        ...
        scaleX = width < height ? 6 : (width == height ? 6 : 4);
        centerX = 0.7f;
        centerY = -1.4f;
