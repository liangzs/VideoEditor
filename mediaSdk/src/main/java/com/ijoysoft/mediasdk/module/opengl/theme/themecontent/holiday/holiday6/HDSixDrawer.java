 ...
 * 全局烟花
 */
public class HDSixDrawer implements IParticleRender {
    ...
    private HDSixSystem particleSystem;
    ...
    public HDSixDrawer() {
        particleSystem = new HDSixSystem();
    }
    ...
    public List<Bitmap> loadBitmaps() {
        return Arrays.asList(
                BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_six_particle1" + ConstantMediaSize.SUFFIX),
                BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_six_particle2" + ConstantMediaSize.SUFFIX),
                BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_six_particle3" + ConstantMediaSize.SUFFIX)
        );
    }
