 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class HDFiveThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new HDFiveThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new HDFiveThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new HDFiveThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new HDFiveThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new HDFiveThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new HDFiveThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new HDFiveThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new HDFiveThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new HDFiveThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new HDFiveThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
