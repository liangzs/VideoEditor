...
import com.ijoysoft.mediasdk.module.opengl.theme.themecontent.birthday.birthday12.BDTwelveParticleSystem;
 ...
 * 最后在fragment中，重写计划
 */
public class BDSeventeenParticleDrawer implements IParticleRender {
    ...
    public BDSeventeenParticleDrawer() {
    ...
    public void onPlepare(int index) {
        ...
        switch (index % 6) {
            case 1:
                ...
                particleSystem.setDelayStart(800);
                break;
            case 3:
                particleSystem.addParticles(-1f);
                particleSystem.setDelayStart(800);
