 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDSixteenThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BDSixteenThemeOne((int) mediaItem.getDuration(), true);
                break;
            case 1:
                actionRender = new BDSixteenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new BDSixteenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new BDSixteenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new BDSixteenThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new BDSixteenThemeOne((int) mediaItem.getDuration(), true);
                break;
            case 1:
                temp = new BDSixteenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new BDSixteenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new BDSixteenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new BDSixteenThemeFive((int) mediaItem.getDuration());
                break;
        }
