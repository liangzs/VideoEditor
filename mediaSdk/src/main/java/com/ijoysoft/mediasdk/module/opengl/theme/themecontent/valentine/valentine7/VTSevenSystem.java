...
public class VTSevenSystem extends BaseParticleSystem {
    ...
    public VTSevenSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        int pointSize = random.nextInt(3);
        particles[currentOffset++] = pointSize;
        if (pointSize == 2) {
            particles[particleOffset + 3] = (3 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 40;//(20,25,30)
