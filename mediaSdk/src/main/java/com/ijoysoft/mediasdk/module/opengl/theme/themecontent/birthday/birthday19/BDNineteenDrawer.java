 ...
 * 最后在fragment中，重写计划
 */
public class BDNineteenDrawer implements IParticleRender {
    ...
    private BDNineteenSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public BDNineteenDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDNineteenSystem(8);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_nineteen_particle1" + ConstantMediaSize.SUFFIX));
