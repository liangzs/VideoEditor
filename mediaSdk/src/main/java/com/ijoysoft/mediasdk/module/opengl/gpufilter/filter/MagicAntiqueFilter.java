...
import static com.ijoysoft.mediasdk.module.opengl.gpufilter.basefilter.GPUImageFilter.NO_FILTER_VERTEX_SHADER;
...
public class MagicAntiqueFilter extends GPUImageFilter {
    ...
    public MagicAntiqueFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.antique));
    }
