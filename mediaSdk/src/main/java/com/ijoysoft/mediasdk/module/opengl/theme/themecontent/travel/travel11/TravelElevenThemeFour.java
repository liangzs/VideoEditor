 ...
 * @ description
 */
public class TravelElevenThemeFour extends BaseBlurThemeExample {
    ...
    public TravelElevenThemeFour(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centerX = width == height ? 0f : (width < height ? 0f : -0.5f);
        ...
        scaleX = width == height ? 12 : (width < height ? 12 : 15);
        scaleY = width == height ? 12 : (width < height ? 12 : 15);
        centerX = width == height ? 0f : (width < height ? 0f : -0.5f);
        centerY = width == height ? -0.9f : (width < height ? -0.9f : -0.85f);
        ...
        widgetSeven.init(mimaps.get(5), width, height);
