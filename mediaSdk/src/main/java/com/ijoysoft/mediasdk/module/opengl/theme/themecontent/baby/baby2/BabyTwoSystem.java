...
public class BabyTwoSystem extends BaseParticleSystem {
    ...
    public BabyTwoSystem(int maxParticleCount) {
    ...
    private void updateParticle(int index) {
        ...
        if (origin - current < 0.5) {
            current = particles[currentOffset + 2] + 3;
    ...
    private void addParticleImpl(int index, float particleStartTime) {
        ...
        temp = (3 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 20;//(20,25,30)
