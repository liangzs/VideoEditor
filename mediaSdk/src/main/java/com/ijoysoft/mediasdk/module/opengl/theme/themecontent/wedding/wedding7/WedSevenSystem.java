 ...
 * @ description
 */
public class WedSevenSystem extends BaseParticleSystem {
    ...
    public WedSevenSystem(int maxParticleCount) {
    ...
    public void addParticle(float particleStartTime) {
        pointSize = ConstantMediaSize.getMinWH() / 30;
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = (4 + random.nextInt(3)) * ConstantMediaSize.getMinWH() / 10;//(20,25,30)
        if (isInit) {
