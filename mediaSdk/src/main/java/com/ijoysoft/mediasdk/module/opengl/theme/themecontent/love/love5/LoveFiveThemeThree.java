 ...
 * @ description
 */
public class LoveFiveThemeThree extends BaseBlurThemeExample {
    ...
    public LoveFiveThemeThree(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerX = width == height ? 0.63f : (width < height ? 0.7f : 0.7f);
        float centerY = width == height ? 0.84f : (width < height ? 0.9f : 0.8f);
