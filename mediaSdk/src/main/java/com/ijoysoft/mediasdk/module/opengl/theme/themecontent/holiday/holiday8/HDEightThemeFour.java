 ...
 * 缩小-放大-缩小
 */
public class HDEightThemeFour extends BaseBlurThemeExample {
    ...
    public HDEightThemeFour(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centerX = -0.8f;
        centerY = 0.8f;
        originOne = widgetThree.adjustScaling(width, height, mimaps.get(2).getWidth(), mimaps.get(2).getHeight(),
                centerX, centerY, scale, scale);
        widgetFour.init(mimaps.get(2), width, height);
        centerX = 0.8f;
        centerY = 0.8f;
        originTwo = widgetFour.adjustScaling(width, height, mimaps.get(2).getWidth(), mimaps.get(2).getHeight(),
                centerX, centerY, scale, scale);
