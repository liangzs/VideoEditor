 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDTenThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BDTenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BDTenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new BDTenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new BDTenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new BDTenThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new BDTenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new BDTenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new BDTenThemeThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new BDTenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new BDTenThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_ten_pre_bg_border" + ConstantMediaSize.SUFFIX));
    }
