...
public class Beat3PreTreatment extends BaseTimePreTreatment {
    @Override
    public List<Bitmap> createMimapBitmaps() {
        List<Bitmap> list = new ArrayList<>();
        list.add(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/beat_three_theme1_1"));
        list.add(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/beat_three_theme2_1"));
        return list;
    }
