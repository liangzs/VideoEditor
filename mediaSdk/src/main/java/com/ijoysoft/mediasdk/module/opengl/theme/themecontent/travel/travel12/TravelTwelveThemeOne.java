 ...
 * @ description
 */
public class TravelTwelveThemeOne extends BaseBlurThemeExample {
    ...
    public TravelTwelveThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
        ...
        float centerY = width == height ? -0.6f : (width < height ? -0.2f : -0.6f);
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centerY = width == height ? -0.6f : (width < height ? -0.2f : -0.6f);
