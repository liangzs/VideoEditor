 ...
 * 上进，上下悬停，左划出
 */
public class TravelEightThemeFour extends BaseThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;

    public TravelEightThemeFour(int totalTime) {
        ...
        outAnimation = new AnimationBuilder(DEFAULT_OUT_TIME).setCoordinate(0, 0f, 2.5f, 0).
                setConors(AnimateInfo.ROTATION.Y_ANXIS_RE, 0, 90).setZView(TravelEightThemeManager.DEFAUT_ZVIEW).build();
    }
