 ...
 * @ description
 */
public class TravelThirteenThemeTwo extends BaseBlurThemeExample {
    private BaseThemeExample widgetBorder;
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;

    public TravelThirteenThemeTwo(int totalTime, boolean isNoZaxis, int width, int height) {
        ...
        float centerY = width == height ? -0.78f : (width < height ? -0.65f : -0.78f);
        ...
        centerX = width == height ? 0.82f : (width < height ? 0.8f : 0.88f);
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //文案
        float scaleX = width == height ? 0f : (width < height ? 1.5f : 0f);
        float scaleY = width == height ? 0f : (width < height ? 1.5f : 0f);
        float centerX = width == height ? 0f : (width < height ? 0f : 0f);
        float centerY = width == height ? 0f : (width < height ? -0.88f : 0f);
        ...
        //左气球
        scaleX = width == height ? 7f : (width < height ? 7f : 6);
        scaleY = width == height ? 7f : (width < height ? 7f : 6f);
        centerX = width == height ? -0.77f : (width < height ? -0.8f : -0.8f);
        centerY = width == height ? -0.78f : (width < height ? -0.65f : -0.78f);
        ...
        //右气球
        scaleX = width == height ? 7f : (width < height ? 7f : 6f);
        scaleY = width == height ? 7f : (width < height ? 7f : 6f);
        centerX = width == height ? 0.82f : (width < height ? 0.8f : 0.88f);
        centerY = width == height ? 0.4f : (width < height ? -0.3f : 0.4f);
