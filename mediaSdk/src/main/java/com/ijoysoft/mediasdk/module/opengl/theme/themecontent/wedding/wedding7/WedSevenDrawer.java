 ...
 * @ description
 */
public class WedSevenDrawer implements IParticleRender {
    ...
    private WedSevenSystem particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new WedSevenSystem(20);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_seven_theme_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_seven_theme_particle3" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/wed_seven_theme_particle3" + ConstantMediaSize.SUFFIX));
