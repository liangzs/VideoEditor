 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDElevenThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BDElevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BDElevenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                actionRender = new BDElevenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new BDElevenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                actionRender = new BDElevenThemeFive((int) mediaItem.getDuration());
                break;
        }
...
//        index = 4;
        switch (index % 5) {
            case 0:
                temp = new BDElevenThemeOne((int) mediaItem.getDuration());
                break;
            case 1:
                temp = new BDElevenThemeTwo((int) mediaItem.getDuration());
                break;
            case 2:
                temp = new BDElevenThemeThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new BDElevenThemeFour((int) mediaItem.getDuration());
                break;
            case 4:
                temp = new BDElevenThemeFive((int) mediaItem.getDuration());
                break;
        }
    ...
    public void initBackgroundTexture () {
        bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_eleven_theme_bg" + ConstantMediaSize.SUFFIX));
    }
