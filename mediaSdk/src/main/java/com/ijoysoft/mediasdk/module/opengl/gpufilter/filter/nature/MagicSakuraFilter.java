...
public class MagicSakuraFilter extends GPUImageFilter {
    ...
    public MagicSakuraFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_sakura));
    }
