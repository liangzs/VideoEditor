 ...
 * stay 缩小
 */
public class TravelFiveThemeThree extends BaseBlurThemeExample {
    ...
    public TravelFiveThemeThree(int totalTime, boolean isNoZaxis, int width, int height) {
        ...
        float centerX = width < height ? 0.7f : (width == height ? 0.75f : 0.8f);
        float centerY = 1;
    ...
    public void initWidget() {
        ...
        //four
        widgetFive = new BaseThemeExample(totalTime, 3000, 0, DEFAULT_OUT_TIME, true);
        widgetFive.setEnterAnimation(new AnimationBuilder(3000).setZView(0).setIsNoZaxis(true).setCoordinate(-0.2f, 0, 0, 0)
                .build());
