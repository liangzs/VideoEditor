 ...
 * stay 放大-缩小
 */
public class BabyFourThemeFive extends BaseBlurThemeExample {
    ...
    public BabyFourThemeFive(int totalTime, boolean isNoZaxis) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        centery = width < height ? 0.85f : 0.75f;
        scaleW = width < height ? 5 : 10;
        scaleH = width < height ? 10 : 5;
        widgetThree.init(mimaps.get(2), width, height);
        originOne = widgetThree.adjustScaling(width / devideX, height / devideY, mimaps.get(2).getWidth(), mimaps.get(2).getHeight(), centerx, centery, scaleW, scaleH);
