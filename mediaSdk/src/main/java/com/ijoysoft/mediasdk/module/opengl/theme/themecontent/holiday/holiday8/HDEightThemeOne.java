 ...
 * 这里在悬停缩放时，添加滤镜
 */
public class HDEightThemeOne extends BaseBlurThemeExample {
    private BaseThemeExample widgetOne;
    private BaseThemeExample widgetTwo;
    private BaseThemeExample widgetThree;

    public HDEightThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        scaleX = width < height ? 6 : 3;
        centerX = -0.7f;
        centerY = width <= height ? 0.7f : 0.8f;
