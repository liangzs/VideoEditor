...
public class MagicEmeraldFilter extends GPUImageFilter {
    ...
    public MagicEmeraldFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.photo_edit_emerald));
    }
