 ...
 * 最后在fragment中，重写计划
 */
public class BDEightteenDrawer implements IParticleRender {
    ...
    private BDEightteenSystem particleSystem;
    private long globalStartTime;
    private int[] textures = {-1, -1};
    private int[] textureLocations = {-1, -1};
    private static final String A_PARTICLE = "a_Paticle";
    private int particleLocation;

    public BDEightteenDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BDEightteenSystem(8);
        globalStartTime = System.currentTimeMillis();
        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_eightteen_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_eightteen_particle2" + ConstantMediaSize.SUFFIX));
