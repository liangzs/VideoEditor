 ...
 * 这里在悬停缩放时，添加滤镜
 */
public class VTNineThemeOne extends BaseBlurThemeExample {
    ...
    public VTNineThemeOne(int totalTime, boolean isNoZaxis, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scale = width < height ? 3 : 4f;
        float centerX = width < height ? -0.6f : (width == height ? -0.7f : -0.75f);
