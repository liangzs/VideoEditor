package com.ijoysoft.mediasdk.module.opengl.theme.themecontent.baby.baby4.particle;
 ...
 * 最后在fragment中，重写计划
 */
public class BabyFourDrawer implements IParticleRender {
    ...
    private BabyFourSystem particleSystem;
    private long globalStartTime;
    private int texture;

    public BabyFourDrawer() {
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new BabyFourSystem(9);
        globalStartTime = System.currentTimeMillis();
        texture = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/baby_four_particle" + ConstantMediaSize.SUFFIX));
    }
