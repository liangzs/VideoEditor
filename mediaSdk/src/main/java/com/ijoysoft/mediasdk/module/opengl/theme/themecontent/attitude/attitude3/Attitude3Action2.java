 ...
 * 态度3
 */
public class Attitude3Action2 extends BaseBlurThemeTemplate {



    public Attitude3Action2(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetMeta == null) {
            widgetMeta = new float[][]{
                    ...
                    //粉色效果
                    {-0.8f, 0.5f, 0.5f, 1f, 1f},
                    //黄色效果
                    {0.9f, 0.5f, 0.6f, 1.2f, 1.2f},
                    //标题
                    {0f, 0.75f, 1.2f, 2.4f, 1.4f},
            };
        }
        return widgetMeta;
    }
