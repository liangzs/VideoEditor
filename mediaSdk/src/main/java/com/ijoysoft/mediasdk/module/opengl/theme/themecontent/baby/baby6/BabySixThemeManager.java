 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BabySixThemeManager extends BaseThemeManager {
...
//        index = 4;
        switch (index % 5) {
            case 0:
                actionRender = new BabySixThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                actionRender = new BabySixThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                actionRender = new BabySixThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                actionRender = new BabySixThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                actionRender = new BabySixThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
...
//        index = 4;
        ...
        switch (index % 5) {
            case 0:
                temp = new BabySixThemeOne((int) mediaItem.getDuration(), true, width, height);
                break;
            case 1:
                temp = new BabySixThemeTwo((int) mediaItem.getDuration(), true);
                break;
            case 2:
                temp = new BabySixThemeThree((int) mediaItem.getDuration(), true);
                break;
            case 3:
                temp = new BabySixThemeFour((int) mediaItem.getDuration(), true);
                break;
            case 4:
                temp = new BabySixThemeFive((int) mediaItem.getDuration(), true);
                break;
        }
