 ...
 * 右边波浪进
 */
public class VTTweleThemeFour extends BaseThemeExample {
    ...
    public VTTweleThemeFour(int totalTime) {
...
//        stayNext = new StayAnimation(1000, AnimateInfo.STAY.SPRING_Y, -2, true);
    ...
    public void initWidget() {
        ...
        widgetTwo.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setCoordinate(0f, -1, 0f, 0f).build());
        widgetTwo.setOutAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setCoordinate(0, 0f, 0f, -1f).build());
        ...
        //three
        widgetFive = new BaseThemeExample(totalTime, DEFAULT_ENTER_TIME, 3000, DEFAULT_OUT_TIME, true);
        widgetFive.setEnterAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setCoordinate(1, 0, 0f, 0f).build());
        widgetFive.setOutAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).setIsNoZaxis(true).setCoordinate(0, 0f, 1f, 0f).build());
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        //five
        widgetFive.init(mimaps.get(2), width, height);
        centerX = 0.8f;
        centerY = 0.9f;
        widgetFive.adjustScaling(width / devideX, height / devideY, mimaps.get(2).getWidth(), mimaps.get(2).getHeight(), centerX, centerY, scaleX, scaleY);
        //four
