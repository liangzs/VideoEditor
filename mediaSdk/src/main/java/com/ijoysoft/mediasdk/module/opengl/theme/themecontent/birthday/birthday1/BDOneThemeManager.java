 ...
 * 所以这里暂时不回收让系统自己回收
 */
public class BDOneThemeManager extends BaseThemeManager {
...
//        index = 5;
        ...
        switch (index % 6) {
            case 0:
                actionRender = new BirthDayActionOne((int) mediaItem.getDuration());
                break;
            case 1:
                actionRender = new BirthDayActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new BirthDayActionThree((int) mediaItem.getDuration());
                break;
            case 3:
                actionRender = new BirthDayActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new BirthDayActionFive((int) mediaItem.getDuration(), width, height);
                break;
            case 5:
                actionRender = new BirthDayActionSix((int) mediaItem.getDuration(), width, height);
                break;
        }
    ...
    public void ratioChange() {
        ...
        switch (ConstantMediaSize.ratioType) {
            case _16_9:
            case _4_3:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_one_theme_bg169"));
                break;
            case _3_4:
            case _9_16:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_one_theme_bg916"));
                break;
            case _1_1:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_one_theme_bg11"));
                break;
            default:
                bgImageFilter.setBackgroundTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/bd_one_theme_bg916"));
                break;
...
//        index = 5;
        switch (index % 6) {
            case 0:
                ...
                break;
            case 1:
                temp = new BirthDayActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new BirthDayActionThree((int) mediaItem.getDuration());
                break;
            case 3:
                temp = new BirthDayActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new BirthDayActionFive((int) mediaItem.getDuration(), width, height);
                break;
            case 5:
                temp = new BirthDayActionSix((int) mediaItem.getDuration(), width, height);
                break;
            default:
                temp = new BirthDayActionOne((int) mediaItem.getDuration());
        }
