 ...
 * 最后在fragment中，重写计划
 */
public class HDEightDrawerTwo implements IParticleRender {
    ...
    private HDEightSystemTwo particleSystem;
    ...
    public void onSurfaceCreated() {
        ...
        particleSystem = new HDEightSystemTwo(10);
        globalStartTime = System.currentTimeMillis();

        textures[0] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_theme_particle1" + ConstantMediaSize.SUFFIX));
        textures[1] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_theme_particle2" + ConstantMediaSize.SUFFIX));
        textures[2] = OpenGlUtils.loadTexture(BitmapUtil.decriptImage(ConstantMediaSize.themePath + "/hd_eight_theme_particle3" + ConstantMediaSize.SUFFIX));
