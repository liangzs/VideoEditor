...
public class MagicFreudFilter extends GPUImageFilter {
    ...
    public MagicFreudFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.mediasdk_filter_freud));
    }
    ...
    protected void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/freud_rand.png");
            }
        });
    }
