...
public class CDNineSystem extends BaseParticleSystem {
    ...
    public CDNineSystem(int maxParticleCount) {
    ...
    private void addParticleImpl(int index, float particleStartTime, boolean isInit) {
        ...
        temp = (2 + random.nextInt(4)) * ConstantMediaSize.getMinWH() / 15;//(20,25,30)
        if (isInit) {
