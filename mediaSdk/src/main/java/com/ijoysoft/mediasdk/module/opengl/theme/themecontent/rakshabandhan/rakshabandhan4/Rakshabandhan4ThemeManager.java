 ...
 * TODO 比例适配
 */
public class Rakshabandhan4ThemeManager extends BaseThemeManager {
    ...
    public Rakshabandhan4ThemeManager() {
        super();
...
//        index=0;
        switch (index % 5) {
            case 0:
                actionRender = new RBFourActionOne((int) mediaItem.getDuration(), width, height);
                break;
            case 1:
                actionRender = new RBFourActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                actionRender = new RBFourActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                actionRender = new RBFourActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                actionRender = new RBFourActionFive((int) mediaItem.getDuration(), width, height);
                break;
        }
...
//        index = 0;
        switch (index % 5) {
            case 1:
                temp = new RBFourActionTwo((int) mediaItem.getDuration(), width, height);
                break;
            case 2:
                temp = new RBFourActionThree((int) mediaItem.getDuration(), width, height);
                break;
            case 3:
                temp = new RBFourActionFour((int) mediaItem.getDuration(), width, height);
                break;
            case 4:
                temp = new RBFourActionFive((int) mediaItem.getDuration(), width, height);
                break;
            default:
                temp = new RBFourActionOne((int) mediaItem.getDuration(), width, height);
        }
