 ...
 */
public class BabyOneThemeFour extends BaseThemeExample {
    ...
    public BabyOneThemeFour(int totalTime, int width, int height) {
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float scaleX = width < height ? 2.4f : 4.8f;
        float scaleY = width < height ? 4.8f : 2.4f;
        float centerX = 0f;
        float centerY = 0.8f;
