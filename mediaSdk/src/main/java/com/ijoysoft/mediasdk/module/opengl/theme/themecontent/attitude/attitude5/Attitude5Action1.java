 ...
 * 态度5
 */
public class Attitude5Action1 extends BaseBlurThemeTemplate {

    public Attitude5Action1(int totalTime, int width, int height) {
    ...
    protected float[][] getWidgetsMeta() {
        if (widgetsMeta == null) {
            widgetsMeta = new float[][]{
                    ...
                    //emoji
                    {Float.MIN_VALUE, Float.MIN_VALUE, 2f, 2f, 2f}
            };
        }
        return widgetsMeta;
    }
