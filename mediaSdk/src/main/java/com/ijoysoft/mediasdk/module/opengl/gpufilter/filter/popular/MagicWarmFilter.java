...
public class MagicWarmFilter extends GPUImageFilter {
    ...
    public MagicWarmFilter(MagicFilterType magicFilterType) {
        super(magicFilterType, NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.mediasdk_filter_warm));
    }
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                inputTextureHandles[1] = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/bluevintage_mask1.webp");
                inputTextureHandles[2] = OpenGlUtils.loadTexture(MediaSdk.getInstance().getContext(), "filter/warm_layer1.webp");
            }
        });
    }
