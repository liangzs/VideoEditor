 ...
 * stay 缩小
 */
public class BDFifteenThemeThree extends BaseBlurThemeExample {
    ...
    public BDFifteenThemeThree(int totalTime, boolean isNoZaxis) {
...
//        widgetOne.setOutAnimation(new AnimationBuilder(DEFAULT_ENTER_TIME).setZView(0).build());
    ...
    public void init(Bitmap bitmap, Bitmap tempBit, List<Bitmap> mimaps, int width, int height) {
        ...
        float centerX = width < height ? 0f : (width == height ? 0f : 0.3f);
        float centerY = width < height ? 0.85f : (width == height ? 0.83f : 0.8f);
