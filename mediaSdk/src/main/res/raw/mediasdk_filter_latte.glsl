...
void main()
{
    ...
    redCurveValue = texture2D(inputImageTexture2, vec2(redCurveValue, 1.0)).g;
    greenCurveValue = texture2D(inputImageTexture2, vec2(greenCurveValue, 1.0)).g;
    blueCurveValue = texture2D(inputImageTexture2, vec2(blueCurveValue, 1.0)).g;
    ...
    redCurveValue = texture2D(inputImageTexture2, vec2(tColor.r, 1.0)).r;
    greenCurveValue = texture2D(inputImageTexture2, vec2(tColor.g, 1.0)).r;
    blueCurveValue = texture2D(inputImageTexture2, vec2(tColor.b, 1.0)).r;
    ...
    textureColor = vec4(ra, ga, ba, 1.0);
    textureColor = (textureColor - base) * strength1 + base;
